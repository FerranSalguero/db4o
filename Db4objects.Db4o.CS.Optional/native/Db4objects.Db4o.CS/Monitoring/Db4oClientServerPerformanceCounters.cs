...
namespace Db4objects.Db4o.CS.Monitoring
{
    public class Db4oClientServerPerformanceCounters : Db4oPerformanceCounters
    {
        ...
        {
            var clientConnections = NewDb4oCounter(PerformanceCounterSpec.NetClientConnections.Id, false);

            var serverEvents = (IObjectServerEvents) server;
        ...
        {
            var instanceName = My<IObjectContainer>.Instance.ToString();
