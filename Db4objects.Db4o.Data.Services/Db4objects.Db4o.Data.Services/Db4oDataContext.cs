...
namespace Db4objects.Db4o.Data.Services
{
    public abstract class Db4oDataContext : IUpdatable
    {
        ...
        private void ProcessCollection(object target, string propertyName, object @object,
            params Func<object, object, bool>[] processors)
        {
        ...
        private static bool TryApplyProcessors(object target, object @object,
            IEnumerable<Func<object, object, bool>> processors)
        {
        ...
        {
            GetProperty(target, propertyName, property =>
            {
                action(property);
                return null;
            });
        ...
        {
            public static readonly IdentityEqualityComparer Default = new IdentityEqualityComparer();
