...
namespace Db4objects.Db4o.CS
{
    ...
    public class Db4oClientServer
    {
        ...
        /// <summary>
        ///     creates a new
        ///     <see cref="Db4objects.Db4o.CS.Config.IServerConfiguration">
        ...
        /// <param name="port">
        ///     the port to be used or 0 if the server should not open a port, specify a value &lt; 0 if an arbitrary free port
        ...
        ///     <see cref="Db4objects.Db4o.Config.IConfiguration.AllowVersionUpdates(bool)">
        ...
        /// 	">
        ///     OpenServer(Db4objects.Db4o.CS.Config.IServerConfiguration,
        ///     string, int)
        /// </seealso>
        ...
        ///     string, int)
        /// </seealso>
        /// <seealso cref="Db4objects.Db4o.IObjectServer.GrantAccess(string, string)">
        ///     Db4objects.Db4o.IObjectServer.GrantAccess(string, string)
        /// </seealso>
        ...
        /// <summary>
        ///     creates a new
        ///     <see cref="Db4objects.Db4o.CS.Config.IClientConfiguration">
        ///         Db4objects.Db4o.CS.Config.IClientConfiguration
        ///     </see>
        /// </summary>
        public static IClientConfiguration NewClientConfiguration()
        {
            var legacy = NewLegacyConfig();
            return new ClientConfigurationImpl(legacy);
        }
