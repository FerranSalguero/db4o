...
namespace Db4objects.Db4o.CS.Internal.Messages
{
    public sealed class MQueryExecute : MsgQuery, IMessageWithResponse
    {
        ...
        private QQuery UnmarshallQuery()
        {
            ...
            var query = (QQuery) ReadObjectFromPayLoad();
        ...
        private sealed class _IRunnable_15 : IRunnable
        {
            ...
            public void Run()
            {
                var query = _enclosing.UnmarshallQuery();
                result.value = _enclosing.WriteQueryResult(_enclosing.ExecuteFully(query
        ...
        private sealed class _IClosure4_35 : IClosure4
        {
            ...
            public object Run()
            {
                var qr = _enclosing.NewQueryResult(query.EvaluationMode());
