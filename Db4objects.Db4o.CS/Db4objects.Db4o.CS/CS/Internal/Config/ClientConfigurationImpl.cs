...
namespace Db4objects.Db4o.CS.Internal.Config
{
    public class ClientConfigurationImpl : NetworkingConfigurationProviderImpl, IClientConfiguration
    {
        ...
        {
            get { return Legacy().GetMessageSender(); }
        }
        ...
        {
            get { return Legacy().TimeoutClientSocket(); }
            set
            {
        ...
        public virtual void ApplyConfigurationItems(IExtClient client)
        {
            ...
            for (var configItemIter = _configItems.GetEnumerator();
                configItemIter.MoveNext
                    ();)
            {
                var configItem = ((IClientConfigurationItem) configItemIter.Current
                    );
