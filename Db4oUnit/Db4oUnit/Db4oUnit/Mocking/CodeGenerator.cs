...
namespace Db4oUnit.Mocking
{
    public class CodeGenerator
    {
        ...
        ///     <see cref="MethodCallRecorder.Verify(db4ounit.mocking.MethodCall[])">
        ///         MethodCallRecorder.Verify(db4ounit.mocking.MethodCall[])
        ///     </see>
        ///     .
        ///     Example:
        ...
        {
            var callStrings = Iterators.Map(calls, new _IFunction4_23());
        ...
        {
            var values = Iterators.Map(Iterators.Iterate(array), new _IFunction4_45()
                );
