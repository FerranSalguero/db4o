...
namespace Db4oUnit.Tests
{
    public class TestRunnerTestCase : ITestCase
    {
        ...
        {
            var greenTest = new RunsGreen();
            var redTest = new RunsRed(FailureException);
            var tests = Iterators.Iterable(new object[] {greenTest, redTest});
        ...
        public virtual void TestRunWithException()
        {
            ...
            //$NON-NLS-1$
            var tests = Iterators.Iterable(new object[] {test});
