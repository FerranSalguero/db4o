...
namespace Db4oUnit
{
    public class ReflectionTestSuiteBuilder : ITestSuiteBuilder
    {
        ...
        public ReflectionTestSuiteBuilder(Type clazz) : this(new[] {clazz})
        {
        }
        ...
        protected virtual IEnumerator FromClass(Type clazz)
        {
            if (typeof (IClassLevelFixtureTest).IsAssignableFrom(clazz))
            {
                ...
                {
                    new ClassLevelFixtureTestSuite
        ...
        private sealed class _IFunction4_26 : IFunction4
        {
            ...
            public object Apply(object arg)
            {
                ...
                try
                {
                    return _enclosing.FromClass(klass);
                }
                catch (Exception e)
                {
        ...
        private sealed class _IClosure4_52 : IClosure4
        {
            ...
            public object Run()
            {
                return (IEnumerator) _enclosing.WithContext(new _IClosure4_54(this, clazz));
            }
            ...
            private sealed class _IClosure4_54 : IClosure4
            {
                ...
                public object Run()
                {
                    return new ContextfulIterator(_enclosing._enclosing.SuiteFor(clazz));
                }
            }
        }
        ...
        private sealed class _IClosure4_63 : IClosure4
        {
            ...
            public object Run()
            {
                return new ContextfulIterator(_enclosing.SuiteFor(clazz));
            }
        }
        ...
        private sealed class _IFunction4_96 : IFunction4
        {
            ...
            public object Apply(object arg)
            {
                ...
                if (!_enclosing.IsTestMethod(method))
                {
                    _enclosing.EmitWarningOnIgnoredTestMethod(clazz, method);
                    return Iterators.Skip;
                }
                return _enclosing.FromMethod(clazz, method);
            }
        }
        ...
        private sealed class _ITestFactory_143 : ITestFactory
        {
            ...
            {
                return _enclosing.CreateTest(_enclosing.NewInstance(clazz), method);
            }
        }
    }
}