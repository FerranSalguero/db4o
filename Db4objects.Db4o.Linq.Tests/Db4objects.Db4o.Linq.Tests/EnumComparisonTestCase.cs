...
namespace Db4objects.Db4o.Linq.Tests
{
    public class EnumComparisonTestCase : AbstractDb4oLinqTestCase
    {
        ...
        {
            var expectedQuery = string.Format("(Person((_style == {0}) or (_name == '{1}')))", style, name);
        ...
        {
            var expectedQuery = string.Format("(Person((_style == {0}) and (_name == '{1}')))", style, name);
        ...
        {
            var expectedQuery = string.Format("(Person(_style == {0}))", style);
        ...
        {
            var expectedQuery = string.Format("(Person(_sex == {0}))", sex);
