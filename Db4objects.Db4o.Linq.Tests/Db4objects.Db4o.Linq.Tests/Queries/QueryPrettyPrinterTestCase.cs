...
namespace Db4objects.Db4o.Linq.Tests.Queries
{
    public class QueryPrettyPrinterTestCase : AbstractDb4oTestCase
    {
        ...
        public void TestAndDoubleDescending()
        {
            var query = CreateQuery();
            query.Constrain(typeof (Person));
            query.Descend("Parent")
                .Descend("Age")
                .Constrain(60)
                .Greater()
                .And(query.Descend("Parent").Descend("Name").Constrain("jb"));
        ...
        public void TestComplexConstraint()
        {
            ...
            query.Descend("Age")
                ...
                .Greater()
                .Equal()
                .And(query.Descend("Age").Constrain("32").Smaller().Equal())
                .Or(query.Descend("Name").Constrain("jb"));
