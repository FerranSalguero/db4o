...
namespace Db4oUnit.Extensions
{
    public partial class AbstractDb4oTestCase : IDb4oTestCase, ITestLifeCycle
    {
        ...
        [NonSerialized] private int _threadCount = DefaultConcurrencyThreadCount;
        ...
        public void TearDown()
        {
            ...
            finally
            {
                var fixture = Fixture();
                fixture.Close();
                var uncaughtExceptions = fixture.UncaughtExceptions();
                fixture.Clean();
        ...
        {
            var fixture = (IMultiSessionFixture) Fixture();
            try
            {
        ...
        protected virtual Db4oTestSuiteBuilder ConcurrenyClientServerSuite(bool embedded,
            string label)
        {
            return new Db4oConcurrencyTestSuiteBuilder(embedded
                ? Db4oFixtures.NewEmbedded(label
                    )
        ...
        {
            var query = NewQuery(transaction);
        ...
        {
            var result = NewQuery(oc, clazz).Execute();
        ...
        protected virtual void Foreach(IExtObjectContainer container, Type clazz, IVisitor4
            visitor)
        {
            var set = NewQuery(container, clazz).Execute();
            while (set.HasNext())
            {
