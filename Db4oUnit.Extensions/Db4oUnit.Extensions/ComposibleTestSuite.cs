...
namespace Db4oUnit.Extensions
{
    public abstract class ComposibleTestSuite : Db4oTestSuite
    {
        ...
        {
            var result = new Type[otherTests.Length + testCases.Length];
            Array.Copy(testCases, 0, result, 0, testCases.Length);
            Array.Copy(otherTests, 0, result, testCases.Length, otherTests.Length);
            return result;
        }
    }
}