...
namespace Db4objects.Db4o.Tests.CLI1
{
    public class CsValueTypesTestCase : AbstractDb4oTestCase
    {
        ...
        {
            var cs = new CsValueTypesTestCase();
            cs.name = "AllNull";
            Store(cs);
        ...
        public void Test()
        {
            var os = NewQuery(typeof (CsValueTypesTestCase)).Execute();
            Assert.AreEqual(2, os.Count);
            var cs1 = (CsValueTypesTestCase) os.Next();
            var cs2 = (CsValueTypesTestCase) os.Next();
            if (cs1.name != null)
            {
                cs1.CheckAllNull();
                cs2.CheckAllPresent();
