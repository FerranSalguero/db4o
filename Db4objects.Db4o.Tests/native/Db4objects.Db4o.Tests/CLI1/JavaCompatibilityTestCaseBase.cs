...
//			Console.WriteLine(output);
            ...
            var expected = Normalize(ExpectedJavaOutput());
        ...
        private void CompileJavaSnippet()
        {
            ...
            var program = JavaCode();
            var stdout = JavaServices.CompileJavaCode(program.MainClassFile, program.SourceCode);
        ...
        private void GenerateDataFile()
        {
            ...
            using (var container = Db4oFactory.OpenFile(GetConfiguration(), DataFilePath()))
            {
