...
namespace Db4objects.Db4o.Tests.CLI1.Handlers
{
    ...
    {
        private static readonly ValueTypeHolder[] Objects =
        {
        ...
        {
            var constraint = Objects[2].Value;
            var query =
                NewDescendingQuery(delegate(IQuery descendingQuery) { descendingQuery.Constrain(constraint).Greater(); });
