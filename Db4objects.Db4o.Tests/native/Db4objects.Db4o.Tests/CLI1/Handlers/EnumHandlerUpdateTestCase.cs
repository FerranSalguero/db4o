...
{
    internal class EnumHandlerUpdateTestCase : HandlerUpdateTestCaseBase
    {
        ...
        {
            var values = new Item[1];
            var item = new Item(EnumAsInteger.Second);
            values[0] = item;
            return values;
        }
