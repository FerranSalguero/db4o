...
{
    internal class StructHandlerUpdateTestCase : LenientHandlerUpdateTestCaseBase
    {
        private static readonly Foo[] data =
        {
        ...
        protected override void AssertArrays(IExtObjectContainer objectContainer, object obj)
        {
            ...
            var fooArray = (Foo[]) itemArrays._aArrayInObject;
