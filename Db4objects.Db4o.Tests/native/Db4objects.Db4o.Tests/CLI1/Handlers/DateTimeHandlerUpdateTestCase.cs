...
{
    internal class DateTimeHandlerUpdateTestCase : LenientHandlerUpdateTestCaseBase
    {
        private static readonly DateTime[] data =
        {
            new DateTime(DateTime.MinValue.Ticks),
        ...
        protected override void AssertArrays(IExtObjectContainer objectContainer, object obj)
        {
            ...
            var dateTimeArray = (DateTime[]) itemArrays._arrayInObject;
        ...
        protected override void AssertValues(IExtObjectContainer objectContainer, object[] values)
        {
            ...
            var nullItem = (Item) values[values.Length - 1];
        ...
        protected override object CreateArrays()
        {
            ...
            Array.Copy(data, 0, itemArrays._dateTimeArray, 0, data.Length);

            itemArrays._untypedObjectArray = new object[data.Length + 1];
            Array.Copy(data, 0, itemArrays._untypedObjectArray, 0, data.Length);

            var dateTimeArray = new DateTime[data.Length + 1];
            Array.Copy(data, 0, dateTimeArray, 0, data.Length);
