...
{
    internal class DecimalHandlerUpdateTestCase : LenientHandlerUpdateTestCaseBase
    {
        ...
        protected override object CreateArrays()
        {
            ...
            var decimalArray = new decimal[data.Length + 1];
            Array.Copy(data, 0, decimalArray, 0, data.Length);
