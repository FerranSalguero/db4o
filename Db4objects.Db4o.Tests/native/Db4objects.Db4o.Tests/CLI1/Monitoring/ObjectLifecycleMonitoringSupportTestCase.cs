...
{
    public class ObjectLifecycleMonitoringSupportTestCase : PerformanceCounterTestCaseBase,
        ICustomClientServerConfiguration
    {
        ...
        public void TestObjectsStored()
        {
            ...
            var item = new Item(new Item(null));
            Store(item);
