...
namespace Db4objects.Db4o.Tests.CLI1.Monitoring
{
    public class ServerNetworkingPerformanceCounterTestCase : PerformanceCounterTestCaseBase, IOptOutAllButNetworkingCS
    {
        ...
        public void TestBytesSent()
        {
            ...
            Func<PerformanceCounter> counterRetriever =
                delegate { return PerformanceCounterSpec.NetBytesSentPerSec.PerformanceCounter(FileSession()); };
            Func<MockServerSocket4, long> delegatingRetriever =
                delegate(MockServerSocket4 mockServerSocket) { return (long) mockServerSocket.BytesSent(); };
        ...
        public void TestBytesReceived()
        {
            ...
            Func<PerformanceCounter> counterRetriever =
                delegate { return PerformanceCounterSpec.NetBytesReceivedPerSec.PerformanceCounter(FileSession()); };
            Func<MockServerSocket4, long> delegatingRetriever =
                delegate(MockServerSocket4 mockServerSocket) { return (long) mockServerSocket.BytesReceived(); };
        ...
        public void TestMessagesSent()
        {
            ...
            Func<PerformanceCounter> counterRetriever =
                delegate { return PerformanceCounterSpec.NetMessagesSentPerSec.PerformanceCounter(FileSession()); };
            Func<MockServerSocket4, long> delegatingRetriever =
                delegate(MockServerSocket4 mockServerSocket) { return (long) mockServerSocket.MessagesSent(); };

            AssertCounter(operation, delegatingRetriever, counterRetriever, ClientCount);
        }

        private void AssertCounter(SocketOperation operation, Func<MockServerSocket4, long> delegatingRetriever,
            Func<PerformanceCounter> counterRetriever, int expectedCount)
        {
            var mockServerSocket = new MockServerSocket4();
