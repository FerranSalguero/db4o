...
namespace Db4objects.Db4o.Tests.CLI1.Monitoring
{
    public class ClientConnectionsPerformanceCounterTestCase : TestWithTempFile
    {
        ...
        {
            return
                PerformanceCounterSpec.NetClientConnections.PerformanceCounter(_server.Ext().ObjectContainer()).RawValue;
        }
        ...
        private void ClientDisconnected(object sender, StringEventArgs e)
        {
            _clientDisconnectedEvent.Set();
        }
    }

    internal class ConnectionCloseEventSupport : IServerConfigurationItem
    {
