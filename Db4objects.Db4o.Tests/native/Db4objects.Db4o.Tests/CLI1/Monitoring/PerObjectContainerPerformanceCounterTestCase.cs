...
{
    public class PerObjectContainerPerformanceCounterTestCase : QueryMonitoringSupportTestCaseBase,
        IOptOutAllButNetworkingCS, ICustomClientServerConfiguration
    {
        ...
        public void Test()
        {
            using (var client1 = OpenNewSession())
            using (var client2 = OpenNewSession())
            {
