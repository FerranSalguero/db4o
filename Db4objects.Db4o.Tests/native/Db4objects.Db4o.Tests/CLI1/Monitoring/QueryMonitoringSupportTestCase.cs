...
{
    internal class QueryMonitoringSupportTestCase : QueryMonitoringSupportTestCaseBase, ICustomClientServerConfiguration
    {
        ...
        {
            using (var counter = PerformanceCounterSpec.QueriesPerSec.PerformanceCounter(FileSession()))
            {
