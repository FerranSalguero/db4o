...
{
    internal class NativeQueryMonitoringSupportTestCase : QueryMonitoringSupportTestCaseBase
    {
        ...
        {
            using (var counter = PerformanceCounterSpec.NativeQueriesPerSec.PerformanceCounter(MonitoredContainer()))
            {
