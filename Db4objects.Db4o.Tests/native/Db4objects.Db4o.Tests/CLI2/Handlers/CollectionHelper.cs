...
namespace Db4objects.Db4o.Tests.CLI2.Handlers
{
    internal class CollectionHelper<T> : ICollectionHelper
    {
        ...
        {
            var item = ItemFactory().NewItem<T>();
        ...
        {
            get { return ElementSpec<T>()._largeElement; }
        }

        public IEnumerable Elements
        {
            get { return ElementSpec<T>()._elements; }
        }

        public object NotContained
        {
            get { return ElementSpec<T>()._notContained; }
        }
        ...
        {
            return
                (GenericCollectionTestFactory) GenericCollectionTypeHandlerTestVariables.CollectionImplementation.Value;
        }
