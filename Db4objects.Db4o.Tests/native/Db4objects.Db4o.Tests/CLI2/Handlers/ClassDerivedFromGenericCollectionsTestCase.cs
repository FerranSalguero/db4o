...
namespace Db4objects.Db4o.Tests.CLI2.Handlers
{
    ...
    public class ClassDerivedFromGenericCollectionsTestUnit : AbstractDb4oTestCase
    {
        ...
        {
            var holder = RetrieveOnlyInstance<CollectionHolder>();
        ...
        {
            return
                (ICollectionInstantiator)
                    ClassDerivedFromGenericCollectionsTestSuite.COLLECTION_INHERITED_TYPE_VARIABLE.Value;
        }
    }
