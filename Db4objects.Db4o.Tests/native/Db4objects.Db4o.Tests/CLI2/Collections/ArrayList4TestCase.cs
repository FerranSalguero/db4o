...
namespace Db4objects.Db4o.Tests.CLI2.Collections
{
    internal class ArrayList4TestCase : ITestLifeCycle
    {
        ...
        {
            var list = new ArrayList4<int>(10);
        ...
        {
            ArrayList4Asserter.TestAddDifferentTypes(ArrayList4Asserter.CreateArrayListAndAssertValues(10),
                "No way my friend");
        }
        ...
        {
            ArrayList4Asserter.AssertRemove(ArrayList4Asserter.CreateArrayListAndAssertValues(10));
        }
        ...
        {
            ArrayList4Asserter.AssertFailEnumerator(
                ArrayList4Asserter.CreateArrayListAndAssertValues(10),
                GetEnumerable(0, 10),
                6,
                20);
        ...
        {
            var list = (ArrayList4<int>) ArrayList4Asserter.CreateArrayListAndAssertValues(100);
