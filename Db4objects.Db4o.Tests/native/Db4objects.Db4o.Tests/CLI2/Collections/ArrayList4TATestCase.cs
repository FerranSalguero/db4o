...
{
    internal class ArrayList4TATestCase : TransparentActivationTestCaseBase, IOptOutSilverlight
    {
#if !SILVERLIGHT
        ...
        {
            var list = (ArrayList4<T>) RetrieveOnlyInstance(typeof (ArrayList4<T>));
...
//            Assert.IsNull(GetField(list, "elements"));
        ...
        {
            var list = RetrieveOnlyInstance<string>();
            AssertRetrievedItem(list);
