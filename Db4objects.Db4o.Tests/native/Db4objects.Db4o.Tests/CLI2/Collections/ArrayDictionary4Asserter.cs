...
{
    internal class ArrayDictionary4Asserter
    {
        ...
        public static void AssertAddKeyValuePair(IDictionary<string, int> dict)
        {
            for (var i = DataLength; i < DataLength*2; i++)
            {
                var keyValuePair = new KeyValuePair<string, int>(string.Format(format, i), i);
            ...
            try
            {
                var keyValuePair = new KeyValuePair<string, int>(string.Format(format, 0), 100);
                dict.Add(keyValuePair);
                Assert.Fail("Should throw ArgumentException.");
            }
            catch (ArgumentException)
            ...
            try
            {
                var keyValuePair = new KeyValuePair<string, int>(null, 100);
                dict.Add(keyValuePair);
                Assert.Fail("Should throw ArgumentNullException.");
            }
            catch (ArgumentNullException)
        ...
        {
            var keyValuePairs = new KeyValuePair<string, int>[dict.Count];
