...
namespace Db4objects.Db4o.Tests.Common.Migration
{
    ...
    {
        private readonly string _legacyAssembly;
        ...
        private string PascalCaseAdapter
        {
            get { return CommonCode + @"
...
"; }
        ...
        private string CamelCaseAdapter
        {
            get { return CommonCode + @"
...
"; }
        ...
        {
            CompilationServices.EmitAssembly(fname, new[] {_legacyAssembly}, GetCode());
        }
