...
namespace Db4objects.Db4o.Tests.NativeQueries.Mocks
{
    public class MockMethodRef : IMethodRef
    {
        ...
        public virtual ITypeRef[] ParamTypes
        {
            get
            {
                var paramTypes = Runtime.GetParameterTypes(_method);
                var types = new ITypeRef[paramTypes.Length];
        ...
        {
            get { return TypeRef(_method.DeclaringType); }
        }

        public virtual ITypeRef ReturnType
        {
            get { return TypeRef(_method.ReturnType); }
        }
