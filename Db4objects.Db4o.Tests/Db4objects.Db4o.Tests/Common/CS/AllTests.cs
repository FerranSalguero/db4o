...
namespace Db4objects.Db4o.Tests.Common.CS
{
    public class AllTests : Db4oTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (Caching.AllTests), typeof (
                    Config.AllTests),
                typeof (Objectexchange.AllTests
                    ),
                typeof (BatchActivationTestCase), typeof (CallConstructorsConfigTestCase), typeof (
                    ClientDisconnectTestCase),
                typeof (ClientTimeOutTestCase), typeof (ClientTransactionHandleTestCase
                    ),
                ...
                typeof (IsAliveConcurrencyTestCase), typeof (IsAliveTestCase),
                typeof (NoTestConstructorsQEStringCmpTestCase
                    ),
                ...
                typeof (PrefetchObjectCountZeroTestCase), typeof (PrimitiveMessageTestCase), typeof (
                    QueryConsistencyTestCase),
                typeof (ReferenceSystemIsolationTestCase), typeof (SendMessageToClientTestCase
                    ),
