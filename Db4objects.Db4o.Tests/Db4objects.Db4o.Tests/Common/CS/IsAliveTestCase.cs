...
namespace Db4objects.Db4o.Tests.Common.CS
{
    public class IsAliveTestCase : TestWithTempFile
    {
        ...
        public virtual void TestIsAlive()
        {
            ...
            var port = server.Ext().Port();
            var client = OpenClient(port);
        ...
        {
            var server = Db4oClientServer.OpenServer(Db4oClientServer.NewServerConfiguration
                (), TempFile(), -1);
        ...
        {
            var client = (ClientObjectContainer) Db4oClientServer.OpenClient
