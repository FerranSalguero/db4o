...
namespace Db4objects.Db4o.Tests.Common.IO
{
    public class AllTests : ComposibleTestSuite
    {
        ...
        {
            new ConsoleTestRunner(typeof (AllTests)).Run();
        }
        ...
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (BlockAwareBinTestSuite), typeof (MemoryBinGrowthTestCase
                    ),
                typeof (MemoryBinIsReusableTestCase), typeof (MemoryIoAdapterTestCase), typeof (
                    NonFlushingStorageTestCase),
                typeof (RandomAccessFileStorageFactoryTestCase), typeof (
                    StorageTestSuite)
            });
        }
        ...
        protected override Type[] ComposeWith()
        {
            return new[]
            {
                typeof (BlockSizeDependentBinTestCase), typeof (IoAdapterTestSuite
                    ),
