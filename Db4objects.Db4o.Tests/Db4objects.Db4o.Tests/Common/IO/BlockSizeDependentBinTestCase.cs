...
namespace Db4objects.Db4o.Tests.Common.IO
{
    ...
    {
        private readonly IntByRef _blockSize = new IntByRef();

        public virtual void Test()
        {
            var configuredBlockSize = 13;
        ...
        private IEmbeddedConfiguration Configure(int configuredBlockSize)
        {
            ...
            config.File.Storage = new BlockSizeDependentStorage
        ...
        public class BlockSizeDependentStorage : StorageDecorator
        {
            ...
            {
                return new BlockSizeDependentBin
                    (bin, _blockSize);
            }
