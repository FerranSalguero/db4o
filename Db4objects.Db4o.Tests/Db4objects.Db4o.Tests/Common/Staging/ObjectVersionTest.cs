...
namespace Db4objects.Db4o.Tests.Common.Staging
{
    public class ObjectVersionTest : AbstractDb4oTestCase
    {
        ...
        {
            var oc = Db();
            var @object = new Item("c1");
            oc.Store(@object);
            var objectInfo1 = oc.GetObjectInfo(@object);
            var oldVer = objectInfo1.GetCommitTimestamp();
            //Update
            @object.SetName("c3");
            oc.Store(@object);
            var objectInfo2 = oc.GetObjectInfo(@object);
            var newVer = objectInfo2.GetCommitTimestamp();
