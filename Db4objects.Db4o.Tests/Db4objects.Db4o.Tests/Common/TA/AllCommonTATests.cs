...
namespace Db4objects.Db4o.Tests.Common.TA
{
    public class AllCommonTATests : Db4oTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (ActivatableTestCase), typeof (ActivationBasedOnConcreteTypeTestCase
                    ),
                typeof (TransparentActivationSupportTestCase), typeof (TAWithGCBeforeCommitTestCase
                    ),
                typeof (Events.AllTests), typeof (Mixed.AllTests
                    ),
                typeof (Nonta.AllTests), typeof (Sample.AllTests
                    ),
                typeof (TA.AllTests)
            };
        }
