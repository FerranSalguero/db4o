...
namespace Db4objects.Db4o.Tests.Common.TA.TA
{
    ...
    {
        private static readonly int[][] Ints1 = {new[] {1, 2, 3}, new[] {4, 5, 6}};
        private static readonly int[][] Ints2 = {new[] {4, 5, 6}, new[] {7, 8, 9}};
        private static readonly LinkedList[][] List1 = {new[] {LinkedList.NewList(5)}, new[] {LinkedList.NewList(5)}};
        private static readonly LinkedList[][] List2 = {new[] {LinkedList.NewList(5)}, new[] {LinkedList.NewList(5)}};
