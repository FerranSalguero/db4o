...
namespace Db4objects.Db4o.Tests.Common.Exceptions
{
    public class AllTests : ComposibleTestSuite
    {
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (ActivationExceptionBubblesUpTestCase), typeof (
                    BackupCSExceptionTestCase),
                typeof (DatabaseClosedExceptionTestCase), typeof (DatabaseReadonlyExceptionTestCase
                    ),
        ...
        protected override Type[] ComposeWith()
        {
            return new[]
            {
                typeof (BackupDb4oIOExceptionTestCase), typeof (IncompatibleFileFormatExceptionTestCase
                    ),
                typeof (InvalidSlotExceptionTestCase), typeof (OldFormatExceptionTestCase), typeof (
                    Propagation.AllTests),
                typeof (InvalidPasswordTestCase
                    )
            };
        }
#endif // !SILVERLIGHT
