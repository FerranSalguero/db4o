...
namespace Db4objects.Db4o.Tests.Common.Exceptions
{
    public class ExceptionSimulatingStorage : StorageDecorator
    {
        ...
        private readonly ExceptionTriggerCondition _triggerCondition
            = new ExceptionTriggerCondition();
        ...
        {
            ResetShutdownState();
            return new ExceptionSimulatingBin(bin, _exceptionFactory
                , _triggerCondition);
        }
        ...
        internal class ExceptionTriggerCondition
        {
            ...
            public bool _triggersException;
        }
        ...
        internal class ExceptionSimulatingBin : BinDecorator
        {
            ...
            internal ExceptionSimulatingBin(IBin bin, IExceptionFactory exceptionFactory, ExceptionTriggerCondition
