...
namespace Db4objects.Db4o.Tests.Common.Btree
{
    public class SearcherTestCase : ITestCase, ITestLifeCycle
    {
        ...
        private static readonly int[] EvenValues = {4, 7, 9, 11};
        private static readonly int[] OddValues = {4, 7, 8, 9, 11};
        private static readonly int[] NonMatches = {3, 5, 6, 10, 12};
        private static readonly int[] Matches = {4, 7, 9, 11};
        ...
        public virtual void TtestPrintResults()
        {
            ...
            int[] evenValues = {4, 7, 9, 11};
            int[] searches = {3, 4, 5, 7, 10, 11, 12};
            for (var i = 0; i < searches.Length; i++)
            {
                var res = Search(evenValues, searches[i]);
                Runtime.Out.WriteLine(res);
            }
        }
