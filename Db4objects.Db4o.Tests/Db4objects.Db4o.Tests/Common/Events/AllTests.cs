...
namespace Db4objects.Db4o.Tests.Common.Events
{
    public class AllTests : ComposibleTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (ActivationEventsTestCase), typeof (ClassRegistrationEventsTestCase
                    ),
                typeof (CreationEventsTestCase), typeof (DeleteEventOnClientTestCase),
                typeof (DeletionEventExceptionTestCase
                    ),
        ...
        protected override Type[] ComposeWith()
        {
            return new[]
            {
                typeof (DeleteOnDeletingCallbackTestCase), typeof (OwnCommitCallbackFlaggedNetworkingTestSuite
                    )
            };
        }
#endif // !SILVERLIGHT
