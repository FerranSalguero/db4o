...
namespace Db4objects.Db4o.Tests.Common.Reflect.Custom
{
    ...
    public class CustomReflector : IReflector
    {
        ...
        private readonly IReflector _delegate = Platform4.ReflectorForType(typeof (CustomReflector
            ));
        ...
        public virtual IReflectClass ForName(string className)
        {
            ...
            var klass = RepositoryForName(className);
            if (null != klass)
            {
                return klass;
            }
        ...
        public virtual IReflectClass ForObject(object obj)
        {
            ...
            var klass = RepositoryForObject(obj);
            if (null != klass)
            {
                return klass;
            }
