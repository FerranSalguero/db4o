...
namespace Db4objects.Db4o.Tests.Common.Reflect.Custom
{
    public class CustomClass : IReflectClass
    {
        ...
        {
            var fields = new IReflectField[fieldNames.Length + 1];
            for (var i = 0; i < fieldNames.Length; ++i)
            {
                fields[i] = new CustomField(_repository
        ...
        public virtual CustomField CustomField
            (string name)
        {
            return (CustomField) GetDeclaredField(
                name);
        }
        ...
        private sealed class _IPredicate4_109 : IPredicate4
        {
            ...
            {
                return candidate is CustomField;
            }
        }
    }
}