...
namespace Db4objects.Db4o.Tests.Common.Concurrency
{
    public class ArrayNOrderTestCase : Db4oClientServerTestCase
    {
        ...
        {
            var item = new Item();
            item.s1 = new[] {new[] {new string[3], new string[3]}, new[] {new string[3], new string[3]}};
            item.s1[0][0][0] = "000";
            item.s1[0][0][1] = "001";
            item.s1[0][0][2] = "002";
            item.s1[0][1][0] = "010";
            ...
            item.s1[1][1][1] = "111";
            item.s1[1][1][2] = "112";
            item.o1 = new[] {new object[2], new object[2]};
            item.o1[0][0] = 0;
            item.o1[0][1] = "01";
            item.o1[1][0] = Convert.ToSingle(10);
            item.o1[1][1] = 1.1;
            Store(item);
        }
        ...
        public virtual void AssertItem(Item item)
        {
            ...
            Assert.AreEqual(item.o1[1][0], Convert.ToSingle(10));
