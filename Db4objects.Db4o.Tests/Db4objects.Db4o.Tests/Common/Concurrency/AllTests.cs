...
namespace Db4objects.Db4o.Tests.Common.Concurrency
{
    public class AllTests : Db4oConcurrencyTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (ArrayNOrderTestCase), typeof (ByteArrayTestCase), typeof (
                    CascadeDeleteDeletedTestCase),
                typeof (CascadeDeleteFalseTestCase), typeof (CascadeOnActivateTestCase
                    ),
                ...
                typeof (GreaterOrEqualTestCase), typeof (IndexedByIdentityTestCase),
                typeof (IndexedUpdatesWithNullTestCase
                    ),
                ...
                typeof (PeekPersistedTestCase), typeof (PersistStaticFieldValuesTestCase), typeof (
                    QueryForUnknownFieldTestCase),
                typeof (QueryNonExistantTestCase), typeof (ReadObjectNQTestCase
                    ),
