...
namespace Db4objects.Db4o.Tests.Common.Config
{
    public class AllTests : ComposibleTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (ClassConfigOverridesGlobalConfigTestSuite
                    ),
                typeof (ConfigurationItemTestCase), typeof (ConfigurationOfObjectClassNotSupportedTestCase
                    ),
                typeof (Config4ImplTestCase), typeof (CustomStringEncodingTestCase),
                typeof (EmbeddedConfigurationItemIntegrationTestCase
                    ),
                ...
                typeof (ObjectTranslatorTestCase), typeof (TransientConfigurationTestSuite), typeof (
                    UnicodeStringEncodingTestCase),
                typeof (UTF8StringEncodingTestCase), typeof (VersionNumbersTestCase
                    )
            });
        }
        ...
        {
            return new[] {typeof (ConfigurationReuseTestSuite)};
        }
#endif // !SILVERLIGHT
    }
}