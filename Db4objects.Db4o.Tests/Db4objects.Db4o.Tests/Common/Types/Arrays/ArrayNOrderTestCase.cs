...
namespace Db4objects.Db4o.Tests.Common.Types.Arrays
{
    public class ArrayNOrderTestCase : AbstractDb4oTestCase
    {
        protected override void Store()
        {
            ...
            strArr[1][1][1] = "111";
            strArr[1][1][2] = "112";
            object[][] objArr = {new object[2], new object[2]};
            objArr[0][0] = 0;
            objArr[0][1] = "01";
            objArr[1][0] = Convert.ToSingle(10);
            objArr[1][1] = 1.1;
        ...
        public virtual void Check(Data data)
        {
            ...
            Assert.AreEqual(Convert.ToSingle(10), data._objArr[1][0]);
