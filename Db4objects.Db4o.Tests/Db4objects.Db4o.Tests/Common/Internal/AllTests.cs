...
namespace Db4objects.Db4o.Tests.Common.Internal
{
    public class AllTests : Db4oTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (Convert.AllTests
                    ),
                typeof (Metadata.AllTests), typeof (Query.AllTests
                    ),
                typeof (BlockConverterTestCase), typeof (ClassMetadataTestCase),
                typeof (ClassMetadataTypeHandlerIntegrationTestCase
                    ),
                ...
                typeof (MarshallerFamilyTestCase), typeof (MarshallingBufferTestCase),
                typeof (MarshallingContextTestCase
                    ),
