...
namespace Db4objects.Db4o.Tests.Common.Querying
{
    public class AllTests : Db4oTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (CascadedDeleteUpdate), typeof (CascadeDeleteArray), typeof (
                    CascadeDeleteDeleted),
                typeof (CascadeDeleteFalse), typeof (CascadeOnActivate), typeof (
                    CascadeOnDeleteTestCase),
                typeof (CascadeOnDeleteHierarchyTestCase), typeof (CascadeOnUpdateTestCase
                    ),
                ...
                typeof (IdListQueryResultTestCase), typeof (IndexedJoinQueriesTestCase),
                typeof (IndexOnParentFieldTestCase
                    ),
                typeof (IndexedQueriesTestCase), typeof (InvalidFieldNameConstraintTestCase), typeof (
                    LazyQueryResultTestCase),
                typeof (MultiFieldIndexQueryTestCase), typeof (NoClassIndexQueryTestSuite
                    ),
