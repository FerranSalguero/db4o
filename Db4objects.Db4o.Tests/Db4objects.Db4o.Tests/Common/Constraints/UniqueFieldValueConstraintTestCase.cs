...
namespace Db4objects.Db4o.Tests.Common.Constraints
{
    public class UniqueFieldValueConstraintTestCase : AbstractDb4oTestCase, ICustomClientServerConfiguration
    {
        ...
        protected override void Configure(IConfiguration config)
        {
            ...
            config.ObjectClass(typeof (IHaveNothingToDoWithItemInstances
        ...
        {
            AddItem("5");
            Store(new IHaveNothingToDoWithItemInstances(unchecked(
                0xdb40)));
            Db().Commit();
            Assert.AreEqual(ExpectedConstructorsCalls(), IHaveNothingToDoWithItemInstances
