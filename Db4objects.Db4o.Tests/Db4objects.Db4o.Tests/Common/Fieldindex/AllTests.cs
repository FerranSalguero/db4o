...
namespace Db4objects.Db4o.Tests.Common.Fieldindex
{
    public class AllTests : ComposibleTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (IndexedNodeTestCase), typeof (FieldIndexTestCase
                    ),
                typeof (FieldIndexProcessorTestCase), typeof (StringFieldIndexTestCase), typeof (
                    DoubleFieldIndexTestCase),
                typeof (RuntimeFieldIndexTestCase), typeof (SecondLevelIndexTestCase
                    ),
                typeof (StringFieldIndexDefragmentTestCase), typeof (StringIndexTestCase), typeof (
                    StringIndexCorruptionTestCase),
        ...
        {
            return new[] {typeof (CommitAfterDroppedFieldIndexTestCase)};
        }
#endif // !SILVERLIGHT
    }
}