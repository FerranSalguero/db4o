...
namespace Db4objects.Db4o.Tests.Common.Fieldindex
{
    ...
    {
        private static readonly string[] _fooValues = {"Andrew", "Richard"};
        ...
        {
            IndexField(config, typeof (FieldIndexItem), "_foo");
        }
        ...
        public virtual void TestTraverseValues()
        {
            ...
            var visitor = new ExpectedVisitor
                (2);
        ...
        {
            return ClassMetadataFor(typeof (FieldIndexItem)).FieldMetadataForName
                ("_foo");
        }
