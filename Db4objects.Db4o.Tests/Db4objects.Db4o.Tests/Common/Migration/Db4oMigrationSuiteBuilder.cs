...
namespace Db4objects.Db4o.Tests.Common.Migration
{
    public class Db4oMigrationSuiteBuilder : ReflectionTestSuiteBuilder
    {
        ...
        {
            return new DisposingIterator(base.GetEnumerator(), _environmentProvider
                );
        }
        ...
        protected override IEnumerator FromClass(Type clazz)
        {
            ...
            var defaultTestSuite = base.FromClass(clazz);
            var migrationTestSuite = MigrationTestSuite(clazz, Db4oLibraries());
        ...
        /// <exception cref="System.Exception"></exception>
        private Db4oMigrationTest MigrationTest(Db4oLibrary library
            , Type clazz)
        {
            var instance = (FormatMigrationTestCaseBase) NewInstance(clazz
                );
        ...
        {
            var libraries = new Db4oLibrary[_specificLibraries.Length];
        ...
        private sealed class _IFunction4_55 : IFunction4
        {
            ...
            public object Apply(object library)
            {
                try
                {
                    return _enclosing.MigrationTest((Db4oLibrary) library, clazz);
                }
                catch (Exception e)
                {
        ...
        private sealed class Db4oMigrationTest : ITest
        {
            ...
            {
                Environment().InvokeInstanceMethod(_test.GetType(), "createDatabaseFor", _version);
            }
