...
namespace Db4objects.Db4o.Tests.Common.Foundation
{
    ...
    public class Arrays4TestCase : ITestCase
    {
        ...
        public virtual void TestCopyOfInt()
        {
            ...
            AssertCopyOf(new[] {42});
            AssertCopyOf(new[] {42, 42});
            AssertCopyOf(new[] {1, 2, 3}, 2);
            AssertCopyOf(new[] {1, 2}, 3);
        }
        ...
        {
            var expectation = new int[newLength];
            Array.Copy(array, 0, expectation, 0, Math.Min(array.Length, newLength));
            return expectation;
        }
