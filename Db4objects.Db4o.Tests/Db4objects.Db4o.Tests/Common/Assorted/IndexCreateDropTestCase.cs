...
namespace Db4objects.Db4o.Tests.Common.Assorted
{
    ...
    {
        private readonly int[] Values = {4, 7, 6, 6, 5, 4, 0, 0};
        ...
        {
            var oc = Fixture().Config().ObjectClass(typeof (IndexCreateDropItem
                ));
        ...
        {
            var q = base.NewQuery();
            q.Constrain(typeof (IndexCreateDropItem));
            return q;
        }
        ...
        public class IndexCreateDropItem
        {
            ...
            public IndexCreateDropItem(int int_, DateTime nullDate) : this(int_, int_ == 0
                ? null
                : string.Empty + int_, int_ == 0 ? nullDate : new DateTime(int_))
            {
            }
        }
    }
