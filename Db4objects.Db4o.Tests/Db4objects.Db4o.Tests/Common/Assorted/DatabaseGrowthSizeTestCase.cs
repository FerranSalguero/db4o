...
namespace Db4objects.Db4o.Tests.Common.Assorted
{
        ...
        , IOptOutIdSystem
    {
        ...
        {
            var fileHeader = FileHeader.NewCurrentFileHeader();
            var variablePart = fileHeader.CreateVariablePart(null);
