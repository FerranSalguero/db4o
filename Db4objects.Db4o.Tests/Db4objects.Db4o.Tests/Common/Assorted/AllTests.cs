...
namespace Db4objects.Db4o.Tests.Common.Assorted
{
    public class AllTests : ComposibleTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (AliasesQueryingTestCase), typeof (AliasesTestCase
                    ),
                typeof (CallbackTestCase), typeof (CanUpdateFalseRefreshTestCase), typeof (CascadeDeleteDeletedTestCase
                    ),
                typeof (CascadedDeleteReadTestCase), typeof (ChangeIdentity),
                typeof (CommitTimeStampsNoSchemaChangesTestCase
                    ),
                ...
                typeof (DeleteSetTestCase), typeof (DeleteReaddChildReferenceTestSuite), typeof (
                    DeleteUpdateTestCase),
                typeof (DescendToNullFieldTestCase), typeof (DualDeleteTestCase
                    ),
                ...
                typeof (GetSingleSimpleArrayTestCase), typeof (HandlerRegistryTestCase), typeof (
                    IndexCreateDropTestCase),
                typeof (IndexedBlockSizeQueryTestCase), typeof (InvalidOffsetInDeleteTestCase
                    ),
                ...
                typeof (ObjectUpdateFileSizeTestCase), typeof (ObjectConstructorTestCase), typeof (
                    ObjectContainerMemberTestCase),
                typeof (PlainObjectTestCase), typeof (PeekPersistedTestCase
                    ),
                typeof (PersistentIntegerArrayTestCase), typeof (PersistStaticFieldValuesTestSuite
                    ),
                typeof (PreventMultipleOpenTestCase), typeof (QueryByInterface),
                typeof (QueryingDoesNotProduceClassMetadataTestCase
                    ),
                ...
                typeof (SystemInfoTestCase), typeof (TransientCloneTestCase),
                typeof (UnknownReferenceDeactivationTestCase
                    ),
        ...
        protected override Type[] ComposeWith()
        {
            return new[]
            {
                typeof (PersistTypeTestCase), typeof (ConcurrentRenameTestCase)
            };
        }
#endif // !SILVERLIGHT
    }
