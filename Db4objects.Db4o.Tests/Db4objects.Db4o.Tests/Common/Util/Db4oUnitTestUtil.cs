...
namespace Db4objects.Db4o.Tests.Common.Util
{
    public class Db4oUnitTestUtil
    {
        ...
        public static Type[] MergeClasses(Type[] classesLeft, Type[] classesRight)
        {
            ...
            var merged = new Type[classesLeft.Length + classesRight.Length];
            Array.Copy(classesLeft, 0, merged, 0, classesLeft.Length);
            Array.Copy(classesRight, 0, merged, classesLeft.Length, classesRight.Length
                );
            return merged;
        }
    }
