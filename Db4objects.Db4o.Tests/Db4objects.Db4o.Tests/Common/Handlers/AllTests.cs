        ...
        protected override Type[] TestCases()
        {
            return new[]
            {
                ...
                typeof (DeleteStringInUntypedFieldTestCase), typeof (DoubleHandlerTestCase), typeof (
                    FloatHandlerTestCase),
                typeof (IgnoreFieldsTypeHandlerTestCase), typeof (IntHandlerTestCase
                    ),
                typeof (LongHandlerTestCase), typeof (MultiDimensionalArrayHandlerTestCase), typeof (
                    MultidimensionalArrayIterator4TestCase),
                typeof (StringBufferHandlerTestCase), typeof (
                    StringHandlerTestCase),
