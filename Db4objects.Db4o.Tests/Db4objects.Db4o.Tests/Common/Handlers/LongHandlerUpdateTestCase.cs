...
namespace Db4objects.Db4o.Tests.Common.Handlers
{
    public class LongHandlerUpdateTestCase : HandlerUpdateTestCaseBase
    {
        ...
        public LongHandlerUpdateTestCase()
        {
            data = new[]
            {
                long.MinValue, long.MinValue + 1, -5, -1, 0, 1, 5, long.MaxValue
                                                                   - 1,
                UsesNullMarkerValue() ? 0 : long.MaxValue
            };
        }
        ...
        protected override object CreateArrays()
        {
            ...
            var dataWrapper = new long[data.Length];
            for (var i = 0; i < data.Length; i++)
            {
