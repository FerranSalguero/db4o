...
namespace Db4objects.Db4o.Tests.Common.Handlers
{
    public class CharHandlerUpdateTestCase : HandlerUpdateTestCaseBase
    {
        ...
        {
            char.MinValue, (char) unchecked(
                0x0000),
            (char) unchecked(0x000F), (char) unchecked(0x00F0),
            (char) unchecked(0x00FF), (char) unchecked(0x0F00), (char) unchecked(
                0x0F0F),
            (char) unchecked(0x0FF0), (char) unchecked(0x0FFF),
            (char) unchecked(0xF000), (char) unchecked(0xF00F), (char) unchecked(
                0xF0F0),
            (char) unchecked(0xF0FF), (char) unchecked(0xFF00),
            (char) unchecked(0xFF0F), (char) unchecked(0xFFF0), (char) unchecked(
                0xFFFF),
            char.MaxValue
        };
