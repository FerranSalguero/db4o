    ...
    public class STETH1TestCase : SodaBaseTestCase
    {
        ...
        public override object[] CreateData()
        {
            return new object[]
            {
                ...
                new STETH1TestCase(
                    "str1"),
                new STETH2(), new STETH2("str1", "str2"), new STETH3(), new STETH3("str1a"
                    , "str2", "str3"),
                new STETH3("str1a", "str2a", null), new STETH4(), new STETH4(
                    "str1a", "str2", "str4"),
        ...
        public virtual void TestOrClass()
        {
            ...
            Expect(q, new[] {4, 5, 6, 7, 8, 9});
        }

        public virtual void TestAndClass()
        {
            var q = NewQuery();
            q.Constrain(typeof (STETH1TestCase
                ));
