...
namespace Db4objects.Db4o.Tests.Common.Soda.Arrays.Object
{
    public class STArrIntegerWTONTestCase : SodaBaseTestCase
    {
        ...
        {
            var arr =
                new STArrIntegerWTONTestCase[5];
            arr[0] = new STArrIntegerWTONTestCase
                ();
            int[][][] content = {};
            arr[1] = new STArrIntegerWTONTestCase
                (content);
            content = new[] {new[] {new int[3], new int[3]}};
            content[0][0][1] = 0;
            content[0][1][0] = 0;
            arr[2] = new STArrIntegerWTONTestCase
                (content);
            content = new[] {new[] {new int[3], new int[3]}};
            content[0][0][0] = 1;
            content[0][1][0] = 17;
            content[0][1][1] = int.MaxValue - 1;
            arr[3] = new STArrIntegerWTONTestCase
                (content);
            ...
            arr[4] = new STArrIntegerWTONTestCase
                (content);
        ...
        public virtual void TestDefaultContainsOne()
        {
            ...
            content[0][0][0] = 17;
            q.Constrain(new STArrIntegerWTONTestCase
                (content));
            Expect(q, new[] {3, 4});
        }
        ...
        {
            var q = NewQuery();
            q.Constrain(typeof (STArrIntegerWTONTestCase
                ));
