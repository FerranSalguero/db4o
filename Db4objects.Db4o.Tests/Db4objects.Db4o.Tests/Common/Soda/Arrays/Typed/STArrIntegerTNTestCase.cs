...
namespace Db4objects.Db4o.Tests.Common.Soda.Arrays.Typed
{
    public class STArrIntegerTNTestCase : SodaBaseTestCase
    {
        ...
        {
            var arr = new
                STArrIntegerTNTestCase[5];
            arr[0] = new STArrIntegerTNTestCase
                ();
            int[][][] content = {};
            arr[1] = new STArrIntegerTNTestCase
                (content);
            content = new[] {new[] {new int[3], new int[3]}};
            content[0][0][1] = 0;
            content[0][1][0] = 0;
            arr[2] = new STArrIntegerTNTestCase
                (content);
            content = new[] {new[] {new int[3], new int[3]}};
            content[0][0][0] = 1;
            content[0][1][0] = 17;
            content[0][1][1] = int.MaxValue - 1;
            arr[3] = new STArrIntegerTNTestCase
                (content);
            ...
            arr[4] = new STArrIntegerTNTestCase
                (content);
        ...
        public virtual void TestDefaultContainsOne()
        {
            ...
            content[0][0][0] = 17;
            q.Constrain(new STArrIntegerTNTestCase
                (content));
            Expect(q, new[] {3, 4});
        }
        ...
        {
            var q = NewQuery();
            q.Constrain(typeof (STArrIntegerTNTestCase
                ));
