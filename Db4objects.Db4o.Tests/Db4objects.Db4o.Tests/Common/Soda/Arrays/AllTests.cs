...
namespace Db4objects.Db4o.Tests.Common.Soda.Arrays
{
    public class AllTests : Db4oTestSuite
    {
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (STArrMixedTestCase), typeof (STArrStringOTestCase), typeof (
                    STArrStringONTestCase),
                typeof (STArrStringTTestCase), typeof (STArrStringTNTestCase
                    ),
                ...
                typeof (ArrayDescendSubQueryTestCase
                    )
            };
        }
    }
