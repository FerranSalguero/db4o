...
namespace Db4objects.Db4o.Tests.Common.Soda.Arrays.Untyped
{
    public class STArrIntegerUNTestCase : SodaBaseTestCase
    {
        ...
        {
            var arr = new
                STArrIntegerUNTestCase[5];
            arr[0] = new STArrIntegerUNTestCase
                ();
            object[][][] content = {};
            arr[1] = new STArrIntegerUNTestCase
                (content);
            content = new[] {new[] {new object[3], new object[3]}};
            content[0][0][1] = 0;
            content[0][1][0] = 0;
            arr[2] = new STArrIntegerUNTestCase
                (content);
            content = new[] {new[] {new object[3], new object[3]}};
            content[0][0][0] = 1;
            content[0][1][0] = 17;
            content[0][1][1] = int.MaxValue - 1;
            arr[3] = new STArrIntegerUNTestCase
                (content);
            ...
            arr[4] = new STArrIntegerUNTestCase
                (content);
        ...
        public virtual void TestDefaultContainsOne()
        {
            ...
            content[0][0][0] = 17;
            q.Constrain(new STArrIntegerUNTestCase
                (content));
            Expect(q, new[] {3, 4});
        }
        ...
        {
            var q = NewQuery();
            q.Constrain(typeof (STArrIntegerUNTestCase
                ));
