...
namespace Db4objects.Db4o.Tests.Common.Soda
{
    public class AllTests : Db4oTestSuite
    {
        protected override Type[] TestCases()
        {
            return new[]
            {
                typeof (STOrderingTestCase), typeof (Arrays.AllTests
                    ),
                typeof (AndJoinOptimizationTestCase), typeof (ByteCoercionTestCase),
                typeof (CollectionIndexedJoinTestCase
                    ),
                ...
                typeof (OrderByParentFieldTestCase), typeof (OrderByWithComparableTestCase), typeof (
                    OrderByWithNullValuesTestCase),
                typeof (OrderedOrConstraintTestCase), typeof (OrderFollowedByConstraintTestCase
                    ),
                ...
                , typeof (STCharTestCase), typeof (STCharWUTestCase), typeof (STDoubleTestCase), typeof (
                    STDoubleWUTestCase),
                typeof (STETH1TestCase), typeof (STFloatTestCase), typeof (STFloatWUTestCase
                    ),
                ...
                typeof (STLongWUTestCase), typeof (STOrTTestCase), typeof (STOrUTestCase), typeof (
                    STOStringTestCase),
                typeof (STOIntegerTestCase), typeof (STOIntegerWTTestCase), typeof (
                    STRTH1TestCase),
                typeof (STSDFT1TestCase), typeof (STShortTestCase), typeof (STShortWUTestCase
                    ),
                typeof (STStringUTestCase), typeof (STRUH1TestCase), typeof (STTH1TestCase), typeof (
                    STUH1TestCase),
                typeof (TopLevelOrderExceptionTestCase), typeof (UntypedEvaluationTestCase
                    ),
