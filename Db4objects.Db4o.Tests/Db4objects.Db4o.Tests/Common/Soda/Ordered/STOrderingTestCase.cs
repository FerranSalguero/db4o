...
namespace Db4objects.Db4o.Tests.Common.Soda.Ordered
{
    ...
    public class STOrderingTestCase : SodaBaseTestCase, IOptOutMultiSession
    {
        ...
        public override object[] CreateData()
        {
            return new object[]
            {
                new OrderTestSubject("Alexandr", 30, 5), new OrderTestSubject
                    ("Cris", 30, 5),
                new OrderTestSubject("Boris", 30, 5), new OrderTestSubject("Helen"
                    , 25, 5),
                new OrderTestSubject("Zeus", 25, 3), new OrderTestSubject("Alexsandra"
                    , 25, 3),
                new OrderTestSubject("Liza", 25, 4), new OrderTestSubject("Bred", 25,
                    3),
                new OrderTestSubject("Liza", 25, 3), new OrderTestSubject("Gregory", 25, 4)
            };
        }
        ...
        public virtual void TestFirstAndSecondFieldsAreIrrelevant()
        {
            ...
            ExpectOrdered(q, new[] {5, 7, 8, 4, 9, 6, 3, 0, 2, 1});
        }
        ...
        public virtual void TestSecondAndThirdFieldsAreIrrelevant()
        {
            ...
            q.Descend("_name").OrderAscending();
            q.Descend("_seniority").OrderAscending();
            ExpectOrdered(q, new[] {5, 7, 9, 3, 8, 6, 4, 0, 2, 1});
        }
        ...
        public virtual void TestOrderByNameAndAgeAscending()
        {
            ...
            q.Descend("_age").OrderAscending();
            q.Descend("_name").OrderAscending();
            ExpectOrdered(q, new[] {5, 7, 9, 3, 6, 8, 4, 0, 2, 1});
        }
        ...
        public virtual void TestAscendingOrderWithOutAge()
        {
            ...
            q.Descend("_seniority").OrderAscending();
            q.Descend("_name").OrderAscending();
            ExpectOrdered(q, new[] {5, 7, 8, 4, 9, 6, 0, 2, 1, 3});
        }
    }
}