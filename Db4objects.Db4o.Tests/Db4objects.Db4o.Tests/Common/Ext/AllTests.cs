...
namespace Db4objects.Db4o.Tests.Common.Ext
{
    public class AllTests : ComposibleTestSuite
    {
        ...
        protected override Type[] TestCases()
        {
            ...
            {
                typeof (Db4oDatabaseTestCase), typeof (RefreshTestCase
                    ),
        ...
        protected override Type[] ComposeWith()
        {
            return new[]
            {
                typeof (TransientFieldRefreshNoClassesOnServerTestCase), typeof (
                    UnavailableClassesWithTranslatorTestCase),
