...
namespace Db4objects.Db4o.Tests.Jre5.Collections.Typehandler
{
    public class ListTypeHandlerStringElementTestSuite : FixtureBasedTestSuite, IDb4oTestCase
    {
        ...
        {
            ListTypeHandlerTestElementsSpec[] elementSpecs = {ListTypeHandlerTestVariables.StringElementsSpec};
            return new[]
            {
                new Db4oFixtureProvider(), ListTypeHandlerTestVariables
                    .ListFixtureProvider,
                new SimpleFixtureProvider(ListTypeHandlerTestVariables.ElementsSpec
                    , elementSpecs),
                ListTypeHandlerTestVariables.TypehandlerFixtureProvider
            };
        }
        ...
        public override Type[] TestUnits()
        {
            return new[]
            {
                typeof (ListTypeHandlerStringElementTestUnit
                    )
            };
        }
        ...
        public class ListTypeHandlerStringElementTestUnit : ListTypeHandlerTestUnitBase
        {
            ...
            {
                var q = NewQuery(ItemFactory().ItemClass());
