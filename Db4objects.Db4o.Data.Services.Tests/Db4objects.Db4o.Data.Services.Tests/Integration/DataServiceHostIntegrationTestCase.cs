...
{
    internal class DataServiceHostIntegrationTestCase : ITestLifeCycle
    {
        private static readonly Uri ServiceUri = new Uri("http://127.0.0.1:666/integration");

        private readonly MockFactory _mockery = new MockFactory(MockBehavior.Strict)
        {
        ...
        public void SetUp()
        {
            _dataHost = new DataServiceHost(typeof (IntegrationDataService), new[] {ServiceUri});
            _dataHost.Open();
        }
