...
namespace Db4objects.Db4o.Data.Services.Tests
{
    public class Db4oDataContextTestCase : AbstractDb4oLinqTestCase
    {
        ...
        public void TestDeleteResource()
        {
            ...
            WithContext(context => { context.DeleteResource(jlocke); });
        ...
        public void TestInvalidCollectionManipulation()
        {
            ...
            WithContext(context =>
            {
                ...
                Assert.Expect(typeof (DataServiceException),
                    () => context.RemoveReferenceFromCollection(eko, "Name", eko));
            });
        }
        ...
        {
            private readonly IObjectContainer _session;
