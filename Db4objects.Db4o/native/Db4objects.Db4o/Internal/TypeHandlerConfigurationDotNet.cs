...
{
    internal class TypeHandlerConfigurationDotNet : TypeHandlerConfiguration
    {
        ...
        {
#if !SILVERLIGHT
            RegisterCollection(typeof (ArrayList));
            RegisterCollection(typeof (CollectionBase));
            RegisterMap(typeof (Hashtable));
            RegisterMap(typeof (HybridDictionary));
#if !CF
            RegisterMap(typeof (DictionaryBase));
#endif
#endif
        ...
        {
            var handler = new GenericCollectionTypeHandler();
            handler.RegisterSupportedTypesWith(delegate(Type type) { RegisterGenericTypeHandler(type, handler); });
