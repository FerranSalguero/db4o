...
namespace Db4objects.Db4o.Internal.Reflect
{
    ...
    {
        protected override IReflectClass CreateClass(Type forType)
        {
    ...
    internal class FastNetClass : NetClass
    {
        public FastNetClass(IReflector reflector, NetReflector netReflector, Type clazz)
            : base(reflector, netReflector, clazz)
        {
        }
    ...
    internal class FastNetField : NetField
    {
