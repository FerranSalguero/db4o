...
namespace Db4objects.Db4o.Collections
{
...
#endif
    {
        ...
        {
            get { return Cast<ICollection>().SyncRoot; }
        }

        public bool IsSynchronized
        {
            get { return Cast<ICollection>().IsSynchronized; }
        }
        ...
        {
            get { return Cast<IDictionary>().IsFixedSize; }
        }
        ...
        {
            get { return Cast<Dictionary<TKey, TValue>>().Comparer; }
        }
