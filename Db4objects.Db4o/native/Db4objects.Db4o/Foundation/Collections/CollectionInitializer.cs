...
namespace Db4objects.Db4o.Foundation.Collections
{
    ...
    public sealed class CollectionInitializer
    {
        ...
        private static Type ResolveCollectionAndElementType(Type interfaceType, IList<Type> genArgs,
            out Type collElemType)
        {
            collElemType = null;
            ...
            Type collElementType)
        {
            ...
            {
                var genericProtocolType = initializerType.MakeGenericType(collElementType);
