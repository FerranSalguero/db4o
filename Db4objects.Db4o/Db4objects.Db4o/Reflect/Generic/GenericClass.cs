...
namespace Db4objects.Db4o.Reflect.Generic
{
    ...
    public class GenericClass : IReflectClass, IDeepClone
    {
        ...
        {
            var reflector = (GenericReflector) obj;
            GenericClass superClass = null;
            if (_superclass != null)
            {
                _superclass = (GenericClass) reflector.ForName(_superclass
                    .GetName());
            }
            var ret = new GenericClass
                (reflector, _delegate, _name, superClass);
            var fields = new GenericField[_fields.Length];
        ...
        public virtual IReflectClass GetSuperclass()
        {
            ...
            var delegateSuperclass = _delegate.GetSuperclass();
        ...
        public virtual bool IsAssignableFrom(IReflectClass subclassCandidate)
        {
            ...
            if (_delegate != null)
            {
                if (subclassCandidate is GenericClass)
                {
                    subclassCandidate = ((GenericClass) subclassCandidate
                        ).GetDelegate();
                }
        ...
        public virtual GenericClass ArrayClass()
        {
            if (_array != null)
            {
                return _array;
