...
namespace Db4objects.Db4o.Reflect.Core
{
    ...
    {
        public static readonly ReflectConstructorSpec UnspecifiedConstructor
            = new ReflectConstructorSpec(TernaryBool.Unspecified
                );

        public static readonly ReflectConstructorSpec InvalidConstructor
            = new ReflectConstructorSpec(TernaryBool.No);

        private readonly object[] _args;
        private readonly TernaryBool _canBeInstantiated;
        private readonly IReflectConstructor _constructor;
