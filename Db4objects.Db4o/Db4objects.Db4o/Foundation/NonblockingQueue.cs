...
namespace Db4objects.Db4o.Foundation
{
    ...
    public class NonblockingQueue : IQueue4
    {
        ...
        {
            var newNode = new List4(null, obj);
        ...
        {
            var origInsertionPoint = _insertionPoint;
            var origNext = _next;
        ...
        private sealed class _Iterator4Impl_82 : Iterator4Impl
        {
            ...
            {
                if (origInsertionPoint != _enclosing._insertionPoint || origNext != _enclosing
                    ._next)
                {
