...
namespace Db4objects.Db4o.Foundation
{
    ...
    public class BlockingQueue : IBlockingQueue4
    {
        ...
        {
            return _lock.Run(new _IClosure4_46(this, timeout));
        }
        ...
        {
            return _lock.Run(new _IClosure4_76(this));
        }
        ...
        protected virtual bool UnsafeWaitForNext(long timeout)
        {
            ...
            var now = Runtime.CurrentTimeMillis();
            while (timeLeft > 0)
            {
                if (_queue.HasNext())
                {
        ...
        private sealed class _IClosure4_30 : IClosure4
        {
            ...
            public object Run()
            {
                return _enclosing._queue.HasNext();
            }
        }
        ...
        private sealed class _IClosure4_38 : IClosure4
        {
            ...
            public object Run()
            {
                return _enclosing._queue.Iterator();
            }
        }
        ...
        private sealed class _IClosure4_46 : IClosure4
        {
            ...
            public object Run()
            {
                return _enclosing.UnsafeWaitForNext(timeout)
                    ? _enclosing.UnsafeNext()
                    : null;
            }
        }
        ...
        private sealed class _IClosure4_95 : IClosure4
        {
            ...
            public object Run()
            {
                return _enclosing._queue.NextMatching(condition);
            }
        }
