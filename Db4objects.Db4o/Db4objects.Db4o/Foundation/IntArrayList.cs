...
namespace Db4objects.Db4o.Foundation
{
    ...
    public class IntArrayList : IEnumerable
    {
        ...
        {
            EnsureCapacity();
            Array.Copy(i_content, index, i_content, index + 1, i_count - index);
        ...
        private void EnsureCapacity()
        {
            ...
            {
                var inc = i_content.Length/2;
                if (inc < 10)
                {
                    inc = 10;
                }
                var temp = new int[i_content.Length + inc];
                Array.Copy(i_content, 0, temp, 0, i_content.Length);
                i_content = temp;
            }
        }
