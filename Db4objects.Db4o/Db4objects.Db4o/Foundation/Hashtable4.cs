...
namespace Db4objects.Db4o.Foundation
{
    ...
    public class Hashtable4 : HashtableBase, IDeepClone, IMap4
    {
        ...
        {
            return DeepCloneInternal(new Hashtable4(null
                ), obj);
        }
        ...
        {
            var intKey = objectKey.GetHashCode();
        ...
        {
            var intKey = HashtableByteArrayEntry.Hash(key);
        ...
        {
            var entry = GetObjectEntry(intKey, objectKey);
        ...
        {
            var entry = GetLongEntry(intKey, longKey);
            return entry == null ? null : entry._object;
        }
