...
namespace Db4objects.Db4o
{
    ...
    ///     <see cref="OpenClient(string, int, string, string)">
    ...
    public class Db4oFactory
    {
        ...
        /// </returns>
        [Obsolete(@"Use Db4oEmbedded.NewConfiguration() instead.")]
        ...
        /// </returns>
        [Obsolete(@"use explicit configuration via Db4oEmbedded.NewConfiguration() instead"
            )]
        public static IConfiguration CloneConfiguration()
        {
            return (Config4Impl) ((IDeepClone) Configure()).DeepClone(null);
        }
        ...
        public static IObjectContainer OpenClient(string hostName, int port, string user,
            string password)
        {
            return OpenClient(CloneConfiguration(), hostName, port, user, password
                );
        }
