...
namespace Db4objects.Db4o.Qlin
{
    ...
    {
        internal static readonly QLinOrderByDirection Ascending = new
            QLinOrderByDirection("ascending", true);

        internal static readonly QLinOrderByDirection Descending = new
            QLinOrderByDirection("descending", false);
