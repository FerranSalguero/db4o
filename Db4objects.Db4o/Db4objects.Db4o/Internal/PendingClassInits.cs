...
namespace Db4objects.Db4o.Internal
{
    ...
    {
        private readonly IQueue4 _inits = new NonblockingQueue();
        private readonly IQueue4 _members = new NonblockingQueue();
        private readonly IQueue4 _statics = new NonblockingQueue();
        private readonly Transaction _systemTransaction;
        private readonly IQueue4 _writes = new NonblockingQueue();
        ...
        internal virtual void Process(ClassMetadata newClassMetadata)
        {
            ...
            var ancestor = newClassMetadata.GetAncestor();
            if (ancestor != null)
            {
                Process(ancestor);
            }
        ...
        private void InitializeAspects()
        {
            ...
            {
                var classMetadata = ((ClassMetadata) _members.Next());
        ...
        private void CheckWrites()
        {
            ...
            {
                var classMetadata = ((ClassMetadata) _writes.Next());
        ...
        private void CheckInits()
        {
            ...
            {
                var classMetadata = ((ClassMetadata) _inits.Next());
