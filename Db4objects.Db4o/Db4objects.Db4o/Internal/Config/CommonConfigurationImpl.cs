...
namespace Db4objects.Db4o.Internal.Config
{
    public class CommonConfigurationImpl : ICommonConfiguration
    {
        ...
        {
            get { return _config.ActivationDepth(); }
            set
            {
                var depth = value;
        ...
        {
            get { return _config.OptimizeNativeQueries(); }
            set
            {
                var optimizeNQ = value;
        ...
        {
            get { return new _IEnvironmentConfiguration_139(this); }
        }
        ...
        {
            get { return _config.MaxStackDepth(); }
            set
            {
                var maxStackDepth = value;
        ...
        private sealed class _IEnvironmentConfiguration_139 : IEnvironmentConfiguration
        {
            ...
            {
                _enclosing._config.EnvironmentContributions().Add(service);
            }
        }
    }
}