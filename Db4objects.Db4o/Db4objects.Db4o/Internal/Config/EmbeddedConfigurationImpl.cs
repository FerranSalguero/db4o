...
namespace Db4objects.Db4o.Internal.Config
{
    public class EmbeddedConfigurationImpl : IEmbeddedConfiguration, ILegacyConfigurationProvider
    {
        ...
        {
            get { return new CacheConfigurationImpl(_legacy); }
        }

        public virtual IFileConfiguration File
        {
            get { return new FileConfigurationImpl(_legacy); }
        }
        ...
        {
            get { return new IdSystemConfigurationImpl(_legacy); }
        }
        ...
        public virtual void ApplyConfigurationItems(IEmbeddedObjectContainer container)
        {
            ...
            for (var configItemIter = _configItems.GetEnumerator();
                configItemIter.MoveNext
                    ();)
            {
                var configItem = ((IEmbeddedConfigurationItem) configItemIter
                    .Current);
