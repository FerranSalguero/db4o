...
namespace Db4objects.Db4o.Internal
{
    ...
    {
        public static readonly HardObjectReference Invalid = new
            HardObjectReference(null, null);
        ...
        public static HardObjectReference PeekPersisted(Transaction
            trans, int id, int depth)
        {
            var obj = trans.Container().PeekPersisted(trans, id, ActivationDepthProvider(trans
