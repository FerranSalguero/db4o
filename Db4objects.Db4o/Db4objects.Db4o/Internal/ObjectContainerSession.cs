...
namespace Db4objects.Db4o.Internal
{
        ...
        , IObjectContainerSpec
    {
        ...
        public ObjectContainerSession(ObjectContainerBase server, Transaction
            trans)
        {
            _server = server;
            _transaction = trans;
        ...
        public virtual void Store(object obj, int depth)
        {
            ...
            {
                CheckClosed();
                _server.Store(_transaction, obj, (depth == Const4.Unspecified
                    ? UpdateDepthProvider
        ...
        public virtual int InstanceCount(ClassMetadata clazz, Transaction
            trans)
        {
        ...
        public virtual void StoreAll(Transaction transaction, IEnumerator
            objects)
        {
