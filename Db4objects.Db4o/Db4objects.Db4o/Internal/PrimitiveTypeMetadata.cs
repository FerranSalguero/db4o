...
namespace Db4objects.Db4o.Internal
{
    ...
    public class PrimitiveTypeMetadata : ClassMetadata
    {
        ...
        // Override
        // do nothing
        internal override sealed void AddToIndex(Transaction trans, int id)
        {
        }
        ...
        // do nothing
        public override sealed bool WriteObjectBegin()
        {
            return false;
        }
        ...
        {
            if (!(obj is PrimitiveTypeMetadata))
            {
                return false;
            }
            var other = (PrimitiveTypeMetadata
                ) obj;
            if (TypeHandler() == null)
            {
