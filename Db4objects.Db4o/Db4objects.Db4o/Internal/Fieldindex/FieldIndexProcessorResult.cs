...
namespace Db4objects.Db4o.Internal.Fieldindex
{
    ...
    {
        public static readonly FieldIndexProcessorResult
            NoIndexFound = new FieldIndexProcessorResult
                (null);

        public static readonly FieldIndexProcessorResult
            FoundIndexButNoMatch = new FieldIndexProcessorResult
                (null);
        ...
        private sealed class _MappingIterator_46 : MappingIterator
        {
            ...
            {
                var composite = (IFieldIndexKey) current;
