...
namespace Db4objects.Db4o.Internal.Marshall
{
    ...
    public abstract class AbstractReadContext : AbstractBufferContext, IInternalReadContext
    {
        ...
        private bool _lastReferenceReadWasReallyNull;
        ...
        public object ReadObject(ITypeHandler4 handlerType)
        {
            ...
            var handler = HandlerRegistry.CorrectHandlerVersion(this, handlerType);
        ...
        public object ReadObject()
        {
            ...
            var classMetadata = ClassMetadataForObjectId(objectId);
            if (null == classMetadata)
            {
                // TODO: throw here
                return null;
            }
            var depth = ActivationDepth().Descend(classMetadata);
            if (PeekPersisted())
            {
                return Container().PeekPersisted(Transaction(), objectId, depth, false);
            }
            var obj = Container().GetByID2(Transaction(), objectId);
            if (null == obj)
            {
                return null;
            }
        ...
        private ClassMetadata ClassMetadataForObjectId(int objectId)
        {
            ...
            var hardRef = Container().GetHardObjectReferenceById(Transaction(
                ), objectId);
        ...
        private sealed class _IClosure4_38 : IClosure4
        {
            ...
            public object Run()
            {
                return _enclosing.ReadAtCurrentSeekPosition(handler);
            }
        }
    }
}