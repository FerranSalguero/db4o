...
namespace Db4objects.Db4o.Internal.Marshall
{
    ...
    {
        private readonly int _addToIDTree;
        private readonly bool _checkIDTree;
        ...
        public virtual object Read()
        {
            ...
            if (_checkIDTree)
            {
                var objectInCacheFromClassCreation = Transaction().ObjectForIdFromCache(ObjectId
                    ());
        ...
        {
            var obj = ReadObject(handler);
            if (obj == null)
            {
                return obj;
            }
            var activationDepth = ActivationDepthProvider().ActivationDepth(int.MaxValue
        ...
        private ClassMetadata ReadObjectHeader()
        {
            ...
            var classMetadata = _objectHeader.ClassMetadata();
            if (classMetadata == null)
            {
                return null;
            }
