...
namespace Db4objects.Db4o.Internal.Fileheader
{
    ...
    public abstract class FileHeader
    {
        ...
        private static readonly FileHeader[] AvailableFileHeaders =
        {
            new
                FileHeader1(),
            new FileHeader2(), new FileHeader3()
        };
        ...
        {
            var length = AvailableFileHeaders[0].Length();
            for (var i = 1; i < AvailableFileHeaders.Length; i++)
            {
        ...
        {
            var fileHeader = new FileHeader3();
        ...
        {
            var reader = new ByteArrayBuffer(ReaderLength());
