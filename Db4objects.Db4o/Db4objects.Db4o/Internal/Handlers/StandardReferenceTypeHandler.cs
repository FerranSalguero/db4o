...
namespace Db4objects.Db4o.Internal.Handlers
{
        ...
        , IReadsObjectIds
    {
        ...
        public virtual object DeepClone(object context)
        {
            ...
            var cloned = (StandardReferenceTypeHandler) Reflection4.NewInstance
                (this);
            if (typeHandlerCloneContext.original is StandardReferenceTypeHandler)
            {
                var original = (StandardReferenceTypeHandler) typeHandlerCloneContext
                    .original;
            ...
            )
        {
            ...
            {
                var tc = (TransactionContext) source;
                var obj = tc._object;
                var id = IdFor(obj, tc._transaction);
                return new PreparedComparisonImpl(id, ReflectClassFor
                    (obj));
            }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (StandardReferenceTypeHandler) obj;
        ...
        private sealed class _MarshallingInfoTraverseAspectCommand_35 : MarshallingInfoTraverseAspectCommand
        {
            ...
            protected override int InternalDeclaredAspectCount(ClassMetadata
                classMetadata)
            {
                return context.ReadInt();
            }
        ...
        private sealed class _MarshallingInfoTraverseAspectCommand_122 : MarshallingInfoTraverseAspectCommand
        {
            ...
            protected override int InternalDeclaredAspectCount(ClassMetadata
                classMetadata)
            {
                var aspectCount = classMetadata._aspects.Length;
