...
namespace Db4objects.Db4o.Internal.Query.Processor
{
    ...
    {
        private readonly QField i_field;

        [NonSerialized] private bool _checkClassMetadataOnly;

        [NonSerialized] internal ClassMetadata _classMetadata;

        [NonSerialized] internal IPreparedComparison _preparedComparison;
        ...
        internal override void EvaluateSelf()
        {
            ...
            if (_classMetadata != null)
            {
                if (!(_classMetadata is PrimitiveTypeMetadata))
                {
                    ...
                    var transactionalObject = _classMetadata.WrapWithTransactionContext(Transaction
                        (), i_object);
        ...
        internal override QCon ShareParent(object a_object, BooleanByRef removeExisting)
        {
            ...
            var obj = i_field.Coerce(a_object);
            if (obj == No4.Instance)
            {
                return null;
            }
            ...
            removeExisting)
        {
            ...
            var newConstraint = new QConClass(i_trans, i_parent, i_field, a_class);
        ...
        private sealed class _IVisitor4_84 : IVisitor4
        {
            ...
            {
                _enclosing.AddConstraint((QCon) obj);
            }
        }
    }
}