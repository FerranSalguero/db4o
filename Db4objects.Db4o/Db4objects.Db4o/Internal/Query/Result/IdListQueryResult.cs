...
namespace Db4objects.Db4o.Internal.Query.Result
{
    ...
    public class IdListQueryResult : AbstractQueryResult, IVisitor4
    {
        ...
        {
            var candidate = (QCandidate) a_tree;
        ...
        {
            var index = clazz.Index();
            if (index is BTreeClassIndexStrategy)
            {
                var btree = ((BTreeClassIndexStrategy) index).Btree();
        ...
        private sealed class _ISortable4_74 : ISortable4
        {
            ...
            {
                _enclosing._ids.Swap(leftIndex, rightIndex);
            }
            ...
            {
                return cmp.Compare(_enclosing.Get(leftIndex), _enclosing.Get(rightIndex
                    ));
            }
        }
        ...
        private sealed class _ISortable4_88 : ISortable4
        {
            ...
            public int Compare(int leftIndex, int rightIndex)
            {
                return cmp.Compare(_enclosing._ids.Get(leftIndex), _enclosing._ids.Get(
                    rightIndex));
            }
        }
