...
namespace Db4objects.Db4o.Internal.Freespace
{
    ...
    public class BlockAwareFreespaceManager : IFreespaceManager
    {
        ...
        {
            var slot = _delegate.AllocateSlot(_blockConverter.BytesToBlocks(length));
            if (slot == null)
            {
                return null;
            }
        ...
        {
            var slot = _delegate.AllocateSafeSlot(_blockConverter.BytesToBlocks(length));
            if (slot == null)
            {
                return null;
            }
        ...
        {
            var slot = _delegate.AllocateTransactionLogSlot(_blockConverter.BytesToBlocks(length
                ));
            if (slot == null)
            {
                return null;
