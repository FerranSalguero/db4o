...
namespace Db4objects.Db4o.Internal
{
    ...
    {
        public static readonly CallbackObjectInfoCollections Emtpy
            = Empty();
        ...
        private static CallbackObjectInfoCollections Empty()
        {
            return new CallbackObjectInfoCollections(ObjectInfoCollectionImpl
