...
namespace Db4objects.Db4o.Internal.References
{
    ...
    public class ReferenceSystemRegistry
    {
        ...
        {
            var res = _referenceSystems.Remove(referenceSystem);
            referenceSystem.Discarded();
            return res;
        }

        private sealed class _IReferenceSource_17 : IReferenceSource
        {
        ...
        private sealed class _IReferenceSource_25 : IReferenceSource
        {
        ...
        private sealed class _IReferenceSource_33 : IReferenceSource
        {
