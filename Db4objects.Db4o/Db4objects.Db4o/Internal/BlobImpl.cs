...
namespace Db4objects.Db4o.Internal
{
    ...
    /// <exclude></exclude>
    public class BlobImpl : IBlob, ICloneable, IDb4oTypeImpl
    {
        public const int CopybufferLength = 4096;
        public string fileName;
        public string i_ext;

        [NonSerialized] private File i_file;

        [NonSerialized] private IBlobStatus i_getStatusFrom;

        public int i_length;

        [NonSerialized] private double i_status = Status.Unused;

        [NonSerialized] private ObjectContainerBase i_stream;

        [NonSerialized] private Transaction i_trans;
        ...
        {
            var path = i_stream.ConfigImpl.BlobPath();
            if (path == null)
            {
                path = "blobs";
            }
