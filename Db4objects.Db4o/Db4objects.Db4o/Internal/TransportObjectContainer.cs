...
namespace Db4objects.Db4o.Internal
{
    ...
    public class TransportObjectContainer : LocalObjectContainer
    {
        ...
        // do nothing
        public override sealed void Free(int a_address, int a_length)
        {
        }

        // do nothing
        public override sealed void Free(Slot slot)
        {
        }
        ...
        public override sealed void WriteHeader(bool startFileLockingThread, bool shuttingDown
            )
        {
        }
        ...
        {
            var obj = base.GetByID2(ta, id);
            if (obj is KnownObjectIdentity)
            {
                var oi = (KnownObjectIdentity
                    ) obj;
                Activate(oi);
        ...
        public override sealed bool NeedsLockFileThread()
        {
            return false;
        }
