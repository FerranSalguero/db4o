...
namespace Db4objects.Db4o.Internal
{
    ...
    internal class WriteUpdateProcessor
    {
        ...
        public virtual void Run()
        {
            ...
            var slot = _transaction.IdSystem().CurrentSlot(_id);
            ...
            var objectBytes = Container().ReadStatefulBufferBySlot(_transaction, _id
                , slot);
        ...
        {
            var oh = new ObjectHeader(_clazz, objectBytes);
            var info = (DeleteInfo) TreeInt.Find(_transaction._delete, _id);
            if (info != null)
            {
            ...
            var context = new DeleteContextImpl(objectBytes, oh, _clazz.ClassReflector
                (), null);
