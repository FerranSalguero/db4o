...
namespace Db4objects.Db4o.Internal
{
    ...
    public class Reflection4
    {
        ...
        {
            var paramClasses = new Type[@params.Length];
        ...
        public static object Invoke(string className, string methodName, Type[] paramClasses
            , object[] @params, object onObject)
        {
            var method = GetMethod(className, methodName, paramClasses);
        ...
        {
            var clazz = ReflectPlatform.ForName(className);
            if (clazz == null)
            {
                return null;
            }
            ...
            )
        {
            ...
            while (curclazz != null)
            {
                try
                {
                    return Runtime.GetDeclaredMethod(curclazz, methodName, paramClasses);
                }
                catch (Exception)
                {
                }
        ...
        public static object Invoke(object obj, string methodName, Type signature, object
            value)
        {
            return Invoke(obj, methodName, new[] {signature}, new[] {value});
        }
        ...
        public static FieldInfo GetField(Type clazz, string name)
        {
            ...
            while (curclazz != null)
            {
                try
                {
                    var field = Runtime.GetDeclaredField(curclazz, name);
