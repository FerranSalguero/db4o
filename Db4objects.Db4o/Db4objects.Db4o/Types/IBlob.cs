...
namespace Db4objects.Db4o.Types
{
    ...
    public interface IBlob : IDb4oType
    {
        ...
        ///     <see cref="Db4objects.Db4o.Ext.Status.Available">
        ///         Db4objects.Db4o.Ext.Status.Available
        ///     </see>
        ...
        ///     <see cref="Db4objects.Db4o.Ext.Status.Completed">
        ///         Db4objects.Db4o.Ext.Status.Completed
        ///     </see>
        ///     the last operation on this field was completed successfully.<br />
        ///     <see cref="Db4objects.Db4o.Ext.Status.Processing">
        ///         Db4objects.Db4o.Ext.Status.Processing
        ///     </see>
