...
namespace Db4objects.Db4o.Config
{
    ...
    public interface IQueryConfiguration
    {
        ...
        ///     <see cref="Db4objects.Db4o.Query.IQuery.Execute()">
        ...
        ///     since the Query#execute()call: committed changes from other transactions,
        ///     <b>
        ///         and
        ///         uncommitted changes from the calling transaction
        ///     </b>
        ...
        ///     <b>
        ///         In lazy mode it can make sense to work in a way one would
        ///         work with collections to avoid concurrent modification exceptions.
        ///     </b>
        ///     For instance one
        ...
        ///     a call is
        ///     <see cref="Db4objects.Db4o.IObjectSet.Count()">
        ...
        /// <seealso cref="EvaluationMode(QueryEvaluationMode)">
