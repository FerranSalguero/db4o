...
namespace Db4objects.Db4o.Config
{
    ...
    /// </remarks>
    /// <since>7.5</since>
    /// <seealso cref="IFileConfigurationProvider.File()">
    ///     IFileConfigurationProvider.File()
    /// </seealso>
    public interface IFileConfiguration
    {
        ...
        IFreespaceConfiguration Freespace { get; }
        ...
        ConfigScope GenerateVersionNumbers { set; }
        ...
        ///         Db4objects.Db4o.Db4oEmbedded.OpenFile(IEmbeddedConfiguration,
        ///         string)
        ///     </see>
        ///     will open files.
