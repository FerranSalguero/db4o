...
namespace Db4objects.Db4o.Config
{
    ...
    ///     - disabled.<br /><br />
    /// </summary>
    /// <seealso cref="IConfiguration.GenerateUUIDs(ConfigScope)">
    ///     IConfiguration.GenerateUUIDs(ConfigScope)
    /// </seealso>
    /// <seealso cref="IConfiguration.GenerateVersionNumbers(ConfigScope)">
    ...
    public sealed class ConfigScope
    {
        ...
        public static readonly ConfigScope Disabled = new ConfigScope
        ...
        public static readonly ConfigScope Individually = new ConfigScope
        ...
        public static readonly ConfigScope Globally = new ConfigScope
