...
namespace Db4objects.Db4o.Config
{
    ...
    ///     <see cref="Db4objects.Db4o.Db4oFactory.Configure()">
    ...
    ///     available with
    ///     <see cref="Db4objects.Db4o.Ext.IExtObjectContainer.Configure()">
    ///         Db4objects.Db4o.Ext.IExtObjectContainer.Configure()
    ///     </see>
    ///     and
    ///     <see cref="Db4objects.Db4o.Ext.IExtObjectServer.Configure()">
    ...
    public interface IConfiguration
    {
        ...
        ///     <see cref="Db4objects.Db4o.IObjectContainer.Activate">
        ...
        ///     <see cref="Db4objects.Db4o.IObjectContainer.Deactivate">
        ...
        /// <seealso cref="Db4objects.Db4o.Config.IObjectClass.MaximumActivationDepth">
        ...
        ///     <see cref="Db4objects.Db4o.Config.IObjectClass.CallConstructor">
        ...
        /// </param>
        /// <seealso cref="Db4objects.Db4o.Config.IObjectClass.CallConstructor">
        ///     Db4objects.Db4o.Config.IObjectClass.CallConstructor
        /// </seealso>
        ...
        /// <summary>
        ///     turns
        ///     <see cref="IObjectClass.MaximumActivationDepth(int)">
        ...
        ///     <see cref="Db4objects.Db4o.Db4oFactory.OpenFile(string)">
        ...
        /// <exception cref="Db4objects.Db4o.Config.GlobalOnlyConfigException"></exception>
        [Obsolete(@"use a custom encrypting  instead")]
        ...
        ///     <see cref="Db4objects.Db4o.Ext.ObjectNotStorableException">
        ...
        /// </param>
        [Obsolete(@"As of version 8.0 please use GenerateCommitTimestamps(bool) instead."
            )]
        ...
        /// <exception cref="Db4objects.Db4o.Config.GlobalOnlyConfigException"></exception>
        [Obsolete(@"Use Storage(Db4objects.Db4o.IO.IStorage) instead.")]
        ...
        ///     When using client-server and the level is set to 0, the server will override this and set it to 1.  To get around
        ///     this you can set the level to -1.  This has the effect of not returning any messages.<br /><br />
        ...
        ///     <see cref="Db4objects.Db4o.Db4oFactory.OpenFile">
        ...
        /// </remarks>
        /// <seealso cref="Db4objects.Db4o.Config.Encoding.StringEncodings">
        ...
        /// <seealso cref="IObjectClass.CascadeOnUpdate(bool)">
        ///     IObjectClass.CascadeOnUpdate(bool)
        /// </seealso>
        /// <seealso cref="Db4objects.Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
        ...
        /// <seealso cref="ICommonConfiguration.MaxStackDepth()">
