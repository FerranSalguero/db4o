...
namespace Db4objects.Db4o.IO
{
    ...
    /// </remarks>
    [Obsolete(
        @"Use classes that implement  instead. The new functionality has been split:  is the factory class to open  adapters.   is the actual implementation of IO access."
        )]
