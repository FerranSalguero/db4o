...
namespace Db4objects.Db4o.Diagnostic
{
    ...
    ///     Install this
    ///     <see cref="Db4objects.Db4o.Diagnostic.IDiagnosticListener">
    ///         Db4objects.Db4o.Diagnostic.IDiagnosticListener
    ///     </see>
    ///     with: <br />
    ///     <code>commonConfig.Diagnostic.AddListener(new DiagnosticToConsole());</code><br />
    /// </remarks>
    /// <seealso cref="Db4objects.Db4o.Diagnostic.IDiagnosticConfiguration">
    ...
    public class DiagnosticToConsole : IDiagnosticListener
    {
        ...
        {
            Runtime.Out.WriteLine(d.ToString());
        }
    }
}