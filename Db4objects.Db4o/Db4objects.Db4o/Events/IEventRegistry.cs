...
{
    /// <summary>
    ///     Provides a way to register event handlers for specific <see cref="IObjectContainer">IObjectContainer</see> events.
    ///     <br />
    ...
    public interface IEventRegistry
    {
        ...
        event EventHandler<QueryEventArgs> QueryStarted;
        ...
        /// <returns>event</returns>
        /// <seealso cref="QueryEventArgs">QueryEventArgs</seealso>
        event EventHandler<QueryEventArgs> QueryFinished;
        ...
        ///     <see cref="CancellableObjectEventArgs.Cancel()">
        ///         CancellableObjectEventArgs.Cancel()
        ///     </see>
        /// </remarks>
        /// <returns>event</returns>
        /// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
        /// <seealso cref="Db4objects.Db4o.IObjectContainer.Store(object)">
        ///     Db4objects.Db4o.IObjectContainer.Store(object)
        /// </seealso>
        event EventHandler<CancellableObjectEventArgs> Creating;
        ...
        /// <returns>event</returns>
        /// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
        /// <seealso cref="Db4objects.Db4o.IObjectContainer.Activate(object, int)">
        ///     Db4objects.Db4o.IObjectContainer.Activate(object, int)
        /// </seealso>
        event EventHandler<CancellableObjectEventArgs> Activating;
        ...
        ///     Db4objects.Db4o.IObjectContainer.Store(object)
        /// </seealso>
        event EventHandler<CancellableObjectEventArgs> Updating;
        ...
        /// <returns>event</returns>
        /// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
        /// <seealso cref="Db4objects.Db4o.IObjectContainer.Delete(object)">
        ...
        /// <returns>event</returns>
        /// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
        /// <seealso cref="Db4objects.Db4o.IObjectContainer.Deactivate(object, int)">
        ///     Db4objects.Db4o.IObjectContainer.Deactivate(object, int)
        /// </seealso>
        ...
        ///     Db4objects.Db4o.IObjectContainer.Delete(object)
        /// </seealso>
        event EventHandler<ObjectInfoEventArgs> Deleted;
        ...
        ///     Db4objects.Db4o.IObjectContainer.Delete(object)
        /// </seealso>
        event EventHandler<ObjectInfoEventArgs> Deactivated;
        ...
        /// <seealso cref="Db4objects.Db4o.IObjectContainer.Commit()">
        ...
        event EventHandler<ClassEventArgs> ClassRegistered;

        /// <summary>
        ///     This event is fired when the
        ///     <see cref="Db4objects.Db4o.IObjectContainer.Close()">
        ...
        /// </summary>
        /// <returns>event</returns>
        event EventHandler<ObjectContainerEventArgs> Closing;
        ...
        /// </summary>
        /// <returns>event</returns>
        event EventHandler<ObjectContainerEventArgs> Opened;
    }
}