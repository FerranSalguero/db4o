...
namespace Db4objects.Db4o.Query
{
    ...
    ///     <see cref="Db4objects.Db4o.Query.IQuery.Constrain">
    ///         Db4objects.Db4o.Query.IQuery.Constrain
    ///     </see>
    ///     .
    ///     <br /><br />
    ///     Constraints can be joined with the methods
    ///     <see cref="Db4objects.Db4o.Query.IConstraint.And">
    ///         Db4objects.Db4o.Query.IConstraint.And
    ///     </see>
    ///     and
    ///     <see cref="Db4objects.Db4o.Query.IConstraint.Or">
    ...
    public interface IConstraint
    {
        ...
        ///     <code>query.Descend("points").Constrain(101).Smaller().And(query.Descend("name").Constrain("Test Pilot0"));	</code>
        ///     <br />
        ...
        ///     For example:<br /><br />
        ///     <code>query.Constrain(typeof(Pilot));</code><br />
        ///     <code>query.Descend("points").Constrain(101).Greater().Or(query.Descend("name").Constrain("Test Pilot0"));</code>
        ///     <br />
        ...
        ///     <see cref="Db4objects.Db4o.Query.IConstraint.Smaller">
        ///         Db4objects.Db4o.Query.IConstraint.Smaller
        ///     </see>
        ///     or
        ///     <see cref="Db4objects.Db4o.Query.IConstraint.Greater">
