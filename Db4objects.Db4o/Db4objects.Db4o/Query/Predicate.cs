...
namespace Db4objects.Db4o.Query
{
    ...
    public abstract class Predicate
    {
        ...
        [NonSerialized] private MethodInfo cachedFilterMethod;
        ...
        public virtual MethodInfo GetFilterMethod()
        {
            ...
            for (var methodIdx = 0; methodIdx < methods.Length; methodIdx++)
            {
                ...
                if ((!method.Name.Equals(PredicatePlatform.PredicatemethodName)) || Runtime.GetParameterTypes
                    (method).Length != 1)
                {
                    continue;
                }
                cachedFilterMethod = method;
                var targetName = Runtime.GetParameterTypes(method)[0].FullName;
        ...
        {
            return Runtime.GetParameterTypes(GetFilterMethod())[0];
        }
        ...
        public virtual bool AppliesTo(object candidate)
        {
            try
            {
                ...
                var ret = filterMethod.Invoke(this, new[] {candidate});
                return ((bool) ret);
            }
            catch (Exception)
            {
