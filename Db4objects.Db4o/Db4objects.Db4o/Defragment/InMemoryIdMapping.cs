...
namespace Db4objects.Db4o.Defragment
{
    ...
    public class InMemoryIdMapping : AbstractIdMapping
    {
        ...
        public override int MappedId(int oldID)
        {
            ...
            var res = (TreeIntObject) TreeInt.Find(_tree, oldID);
            if (res != null)
            {
        ...
        {
            var node = (IdSlotTree) _idsToSlots.Find(id);
            if (node == null)
            {
        ...
        private sealed class _IVisitable_62 : IVisitable
        {
            ...
            {
                Tree.Traverse(_enclosing._idsToSlots, new _IVisitor4_64(outSideVisitor));
            }
