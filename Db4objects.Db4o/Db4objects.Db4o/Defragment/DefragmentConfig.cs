...
namespace Db4objects.Db4o.Defragment
{
    ...
    public class DefragmentConfig
    {
        ...
        private static readonly IStoredClassFilter Nullfilter = new NullFilter
            ();
        ...
        private bool _forceBackupDelete;
        private int _objectCommitFrequency;
        private bool _readOnly = true;
        private IStoredClassFilter _storedClassFilter;
        ...
        ///     during the defragment process.
        /// </param>
        [Obsolete(@"since 7.9: use Db4oConfig(Db4objects.Db4o.Config.IEmbeddedConfiguration) instead"
            )]
