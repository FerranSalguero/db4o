...
namespace Db4objects.Db4o
{
    ...
    ///     <see cref="Db4oFactory.OpenServer(string, int)">
    ...
    ///     <see cref="Db4oFactory.OpenClient(string, int, string, string)">
    ...
    /// <seealso cref="Db4objects.Db4o.Ext.IExtObjectServer">
    ...
    public interface IObjectServer : IDisposable
    {
        ...
        ///     <see cref="IObjectServer"></see>
        ///     can be casted to an
        ///     <see cref="Db4objects.Db4o.Ext.IExtObjectServer">
