...
namespace Db4objects.Db4o.Monitoring
{
    public class NativeQueryMonitoringSupport : IConfigurationItem
    {
        ...
        public void Apply(IInternalObjectContainer container)
        {
            ...
            var unoptimizedNativeQueriesPerSec =
                Db4oPerformanceCounters.CounterFor(PerformanceCounterSpec.UnoptimizedNativeQueriesPerSec, false);
            var nativeQueriesPerSec = Db4oPerformanceCounters.CounterFor(PerformanceCounterSpec.NativeQueriesPerSec,
                false);
...
#if NET_3_5
                container.WithEnvironment(delegate { My<LinqQueryMonitor>.Instance.Dispose(); });
#endif
            };
        }

#if NET_3_5
        private class LinqQueryMonitor : ILinqQueryMonitor
        {
            ...
            public void Initialize()
            {
                ...
                _unoptimizedQueriesPerSec =
                    Db4oPerformanceCounters.CounterFor(PerformanceCounterSpec.UnoptimizedLinqQueriesPerSec, false);
            }
        }
#endif
    }
    ...
    public class QueryMonitoringSupport : IConfigurationItem
    {
        ...
        public void Apply(IInternalObjectContainer container)
        {
            ...
            container.WithEnvironment(delegate
            {
                ...
                classIndexScansPerSec = Db4oPerformanceCounters.CounterFor(
                    PerformanceCounterSpec.ClassIndexScansPerSec, false);
            });

            var eventRegistry = EventRegistryFactory.ForObjectContainer(container);
            eventRegistry.QueryFinished += delegate { queriesPerSec.Increment(); };
        ...
        private class DiagnosticListener : IDiagnosticListener
        {
            ...
            {
                var classIndexScan = d as LoadedFromClassIndex;
