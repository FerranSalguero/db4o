...
namespace Db4objects.Db4o.IO
{
    ...
    public class DebugIoAdapter : VanillaIoAdapter
    {
        ...
        private static readonly int[] RangeOfInterest = {0, 20};
        ...
        public override IoAdapter Open(string path, bool lockFile, long initialLength, bool
            readOnly)
        {
            return new DebugIoAdapter(new RandomAccessFileAdapter(), path,
        ...
        public override void Seek(long pos)
        {
            ...
            {
                counter++;
                Runtime.Out.WriteLine("seek: " + pos + "  counter: " + counter);
            }
            base.Seek(pos);
        }
    }
