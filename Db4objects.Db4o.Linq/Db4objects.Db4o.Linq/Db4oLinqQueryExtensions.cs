...
namespace Db4objects.Db4o.Linq
{
    ...
    {
        public static IDb4oLinqQuery<TSource> Where<TSource>(this IDb4oLinqQuery<TSource> self,
            ...
            Func<IDb4oLinqQueryInternal<TSource>, IEnumerable<TSource>> fallbackProcessor)
        {
            ...
            {
                return
                    new UnoptimizedQuery<TSource>(
                        fallbackProcessor((IDb4oLinqQueryInternal<TSource>) EnsureDb4oQuery(query)));
            }
            try
            {
        ...
        public static IDb4oLinqQuery<TSource> OrderBy<TSource, TKey>(this IDb4oLinqQuery<TSource> self,
            Expression<Func<TSource, TKey>> expression)
        {
        ...
        public static IDb4oLinqQuery<TSource> OrderByDescending<TSource, TKey>(this IDb4oLinqQuery<TSource> self,
            Expression<Func<TSource, TKey>> expression)
        {
        ...
        public static IDb4oLinqQuery<TSource> ThenBy<TSource, TKey>(this IDb4oLinqQuery<TSource> self,
            Expression<Func<TSource, TKey>> expression)
        {
            return ProcessOrderBy(self, new OrderByAscendingClauseVisitor(), expression,
