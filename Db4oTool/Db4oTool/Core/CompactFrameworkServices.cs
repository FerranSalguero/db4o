...
namespace Db4oTool.Core
{
    public class CompactFrameworkServices
    {
        ...
        {
            var assemblyFolderExKey =
                Registry.LocalMachine.OpenSubKey(
                    string.Format(@"SOFTWARE\Microsoft\.NETCompactFramework\v{0}\WindowsCE\AssemblyFoldersEx", cfVersion));
