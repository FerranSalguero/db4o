...
{
    internal class BindMethodEmitter : MethodEmitter
    {
        ...
        {
            var bind = NewExplicitMethod(typeof (IActivatable).GetMethod("Bind"));
            var cil = bind.Body.GetILProcessor();

            var activatorSetting = cil.Create(OpCodes.Ldarg_0);
            ...
            var isParameterNullInstruction = cil.Create(OpCodes.Ldarg_1);
