...
namespace Db4oTool.Tests.TA
{
    public abstract class TATestCaseBase : ITestCase
    {
        ...
        {
            return Db4oToolTestServices.AssemblyFromResource(resourceName, typeof (TATestCaseBase), true, delegate { },
                references);
        }
        ...
        private string InstrumentAssembly(AssemblyDefinition assembly, IAssemblyInstrumentation instrumentation)
        {
            ...
            var assemblyFullPath = assembly.MainModule.FullyQualifiedName;
            var context = new InstrumentationContext(Configuration(assemblyFullPath), assembly);
        ...
        {
            var configuration = new Configuration(assemblyLocation);
