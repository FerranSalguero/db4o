...
{
    internal class TANonStorableTypeTestCase : SingleResourceTestCase
    {
        ...
        protected override string EmitAssemblyFromResource(string resource, Assembly[] references)
        {
            ...
            CompilationServices.Unsafe.Using(true,
                delegate { returnValue = BaseEmitAssemblyFromResource(resource, references); });
            return returnValue;
        }
