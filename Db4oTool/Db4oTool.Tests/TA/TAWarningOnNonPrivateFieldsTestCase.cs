...
{
    internal class TAWarningOnNonPrivateFieldsTestCase : TAOutputListenerTestCaseBase
    {
        public void TestWarningOnNonPrivateFields()
        {
            var assembly = GenerateAssembly("TAClassWithNonPrivateFieldsSubject");
            InstrumentAndAssert(
        ...
        {
            var assembly = GenerateAssembly("TANoFalsePositiveWarningsForNonPrivateFields");
            InstrumentAndAssert(
                AssemblyPath(assembly),
