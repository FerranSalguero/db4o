...
{
    internal class ReflectionServices
    {
        public static Instruction FindInstruction(AssemblyDefinition assembly, string typeName, string testMethodName,
            OpCode testInstruction)
        {
            var testMethod = FindMethod(assembly, typeName, testMethodName);
        ...
        {
            var current = method.Body.Instructions[0];
