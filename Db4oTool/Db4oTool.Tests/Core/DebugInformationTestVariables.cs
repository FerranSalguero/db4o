...
{
    internal sealed class DebugInformationTestVariables
    {
        ...
        public static readonly IFixtureProvider DebugSymbolsFixtureProvider =
            new SimpleFixtureProvider(DebugSymbolsAvailable,
                new object[]
                {
                    LabeledBool.Create(true, "Available"),
                    LabeledBool.Create(false, "Unavailable")
    ...
    internal sealed class LabeledBool : ILabeled
    {
